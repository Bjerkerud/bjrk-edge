...
static ngx_conf_bitmask_t  ngx_mail_pop3_auth_methods[] = {
    ...
    { ngx_string("apop"), bjrk-edge_MAIL_AUTH_APOP_ENABLED },
...
ngx_mail_pop3_merge_srv_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (conf->auth_methods & bjrk-edge_MAIL_AUTH_PLAIN_ENABLED) {
        conf->auth_methods |= bjrk-edge_MAIL_AUTH_LOGIN_ENABLED;
    }
