...
static ngx_conf_bitmask_t  ngx_mail_smtp_auth_methods[] = {
    { ngx_string("plain"), bjrk-edge_MAIL_AUTH_PLAIN_ENABLED },
    { ngx_string("login"), bjrk-edge_MAIL_AUTH_LOGIN_ENABLED },
    { ngx_string("cram-md5"), bjrk-edge_MAIL_AUTH_CRAM_MD5_ENABLED },
    { ngx_string("external"), bjrk-edge_MAIL_AUTH_EXTERNAL_ENABLED },
    { ngx_string("none"), bjrk-edge_MAIL_AUTH_NONE_ENABLED },
    { ngx_null_string, 0 }
};
...
ngx_mail_smtp_create_srv_conf(ngx_conf_t *cf)
{
    ...
    sscf->client_buffer_size = bjrk-edge_CONF_UNSET_SIZE;
    sscf->greeting_delay = bjrk-edge_CONF_UNSET_MSEC;
...
ngx_mail_smtp_merge_srv_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    ngx_conf_merge_bitmask_value(conf->auth_methods,
                              ...
                              (bjrk-edge_CONF_BITMASK_SET
                               |bjrk-edge_MAIL_AUTH_PLAIN_ENABLED
                               |bjrk-edge_MAIL_AUTH_LOGIN_ENABLED));
    ...
    *p++ = CR; *p = LF;
    ...
    for (m = bjrk-edge_MAIL_AUTH_PLAIN_ENABLED, i = 0;
         m <= bjrk-edge_MAIL_AUTH_EXTERNAL_ENABLED;
         m <<= 1, i++)
    {
