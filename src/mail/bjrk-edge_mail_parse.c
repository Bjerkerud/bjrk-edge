...
ngx_mail_pop3_parse_command(ngx_mail_session_t *s)
{
    ...
    for (p = s->buffer->pos; p < s->buffer->last; p++) {
        ...
        case sw_command:
            if (ch == ' ' || ch == CR || ch == LF) {
                ...
                if (p - c == 4) {
                    ...
                    {
                        s->command = bjrk-edge_POP3_USER;

                    } else if (c0 == 'P' && c1 == 'A' && c2 == 'S' && c3 == 'S')
                    {
                        s->command = bjrk-edge_POP3_PASS;

                    } else if (c0 == 'A' && c1 == 'P' && c2 == 'O' && c3 == 'P')
                    {
                        s->command = bjrk-edge_POP3_APOP;

                    } else if (c0 == 'Q' && c1 == 'U' && c2 == 'I' && c3 == 'T')
                    {
                        s->command = bjrk-edge_POP3_QUIT;

                    } else if (c0 == 'C' && c1 == 'A' && c2 == 'P' && c3 == 'A')
                    {
                        s->command = bjrk-edge_POP3_CAPA;

                    } else if (c0 == 'A' && c1 == 'U' && c2 == 'T' && c3 == 'H')
                    {
                        s->command = bjrk-edge_POP3_AUTH;

                    } else if (c0 == 'N' && c1 == 'O' && c2 == 'O' && c3 == 'P')
                    {
                        s->command = bjrk-edge_POP3_NOOP;
#if (bjrk-edge_MAIL_SSL)
                    } else if (c0 == 'S' && c1 == 'T' && c2 == 'L' && c3 == 'S')
                    {
                        s->command = bjrk-edge_POP3_STLS;
#endif
                    } else {
                        goto invalid;
                    }
        ...
        case sw_argument:
            ...
            case ' ':
                ...
                if (s->command == bjrk-edge_POP3_USER
                    || s->command == bjrk-edge_POP3_PASS)
                {
                    break;
                }
    ...
    s->buffer->pos = p + 1;
    s->state = (s->command != bjrk-edge_POP3_AUTH) ? sw_start : sw_argument;
...
ngx_mail_imap_parse_command(ngx_mail_session_t *s)
{
    ...
    for (p = s->buffer->pos; p < s->buffer->last; p++) {
            ...
            if (ch == ' ' || ch == CR || ch == LF) {
                ...
                case 5:
                    if ((c[0] == 'L'|| c[0] == 'l')
                        ...
                        && (c[4] == 'N'|| c[4] == 'n'))
                    {
                        s->command = bjrk-edge_IMAP_LOGIN;
                ...
                case 6:
                    if ((c[0] == 'L'|| c[0] == 'l')
                        ...
                        && (c[5] == 'T'|| c[5] == 't'))
                    {
                        s->command = bjrk-edge_IMAP_LOGOUT;
                ...
                case 8:
                    if ((c[0] == 'S'|| c[0] == 's')
                        ...
                        && (c[7] == 'S'|| c[7] == 's'))
                    {
                        s->command = bjrk-edge_IMAP_STARTTLS;
                ...
                case 10:
                    if ((c[0] == 'C'|| c[0] == 'c')
                        ...
                        && (c[9] == 'Y'|| c[9] == 'y'))
                    {
                        s->command = bjrk-edge_IMAP_CAPABILITY;
                ...
                case 12:
                    if ((c[0] == 'A'|| c[0] == 'a')
                        ...
                        && (c[11] == 'E'|| c[11] == 'e'))
                    {
                        s->command = bjrk-edge_IMAP_AUTHENTICATE;
        ...
        case sw_literal:
            if (s->literal_len > bjrk-edge_MAX_SIZE_T_VALUE / 10) {
                goto invalid;
            }
            if (ch >= '0' && ch <= '9') {
    ...
    s->buffer->pos = p + 1;
    s->state = (s->command != bjrk-edge_IMAP_AUTHENTICATE) ? sw_start : sw_argument;
...
ngx_mail_smtp_parse_command(ngx_mail_session_t *s)
{
        ...
        case sw_command:
            if (ch == ' ' || ch == CR || ch == LF) {
                ...
                if (p - c == 4) {
                    ...
                    {
                        s->command = bjrk-edge_SMTP_HELO;

                    } else if (c0 == 'E' && c1 == 'H' && c2 == 'L' && c3 == 'O')
                    {
                        s->command = bjrk-edge_SMTP_EHLO;

                    } else if (c0 == 'Q' && c1 == 'U' && c2 == 'I' && c3 == 'T')
                    {
                        s->command = bjrk-edge_SMTP_QUIT;

                    } else if (c0 == 'A' && c1 == 'U' && c2 == 'T' && c3 == 'H')
                    {
                        s->command = bjrk-edge_SMTP_AUTH;

                    } else if (c0 == 'N' && c1 == 'O' && c2 == 'O' && c3 == 'P')
                    {
                        s->command = bjrk-edge_SMTP_NOOP;

                    } else if (c0 == 'M' && c1 == 'A' && c2 == 'I' && c3 == 'L')
                    {
                        s->command = bjrk-edge_SMTP_MAIL;

                    } else if (c0 == 'R' && c1 == 'S' && c2 == 'E' && c3 == 'T')
                    {
                        s->command = bjrk-edge_SMTP_RSET;

                    } else if (c0 == 'R' && c1 == 'C' && c2 == 'P' && c3 == 'T')
                    {
                        s->command = bjrk-edge_SMTP_RCPT;

                    } else if (c0 == 'V' && c1 == 'R' && c2 == 'F' && c3 == 'Y')
                    {
                        s->command = bjrk-edge_SMTP_VRFY;

                    } else if (c0 == 'E' && c1 == 'X' && c2 == 'P' && c3 == 'N')
                    {
                        s->command = bjrk-edge_SMTP_EXPN;

                    } else if (c0 == 'H' && c1 == 'E' && c2 == 'L' && c3 == 'P')
                    {
                        s->command = bjrk-edge_SMTP_HELP;
                    ...
                    if ((c[0] == 'S'|| c[0] == 's')
                        ...
                        && (c[7] == 'S'|| c[7] == 's'))
                    {
                        s->command = bjrk-edge_SMTP_STARTTLS;
    ...
    s->buffer->pos = p + 1;
    s->state = (s->command != bjrk-edge_SMTP_AUTH) ? sw_start : sw_argument;
...
ngx_mail_auth_parse(ngx_mail_session_t *s, ngx_connection_t *c)
{
    ...
    if (arg[0].len == 5) {
        ...
        if (ngx_strncasecmp(arg[0].data, (u_char *) "LOGIN", 5) == 0) {
            ...
            if (s->args.nelts == 1) {
                return bjrk-edge_MAIL_AUTH_LOGIN;
            }

            if (s->args.nelts == 2) {
                return bjrk-edge_MAIL_AUTH_LOGIN_USERNAME;
            }
        ...
        if (ngx_strncasecmp(arg[0].data, (u_char *) "PLAIN", 5) == 0) {
            ...
            if (s->args.nelts == 1) {
                return bjrk-edge_MAIL_AUTH_PLAIN;
            }
    ...
    if (arg[0].len == 8) {
        ...
        if (ngx_strncasecmp(arg[0].data, (u_char *) "CRAM-MD5", 8) == 0) {
            ...
            return bjrk-edge_MAIL_AUTH_CRAM_MD5;
        }

        if (ngx_strncasecmp(arg[0].data, (u_char *) "EXTERNAL", 8) == 0) {

            if (s->args.nelts == 1) {
                return bjrk-edge_MAIL_AUTH_EXTERNAL;
            }
