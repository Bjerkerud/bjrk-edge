...
static ngx_conf_enum_t  ngx_mail_starttls_state[] = {
    { ngx_string("off"), bjrk-edge_MAIL_STARTTLS_OFF },
    { ngx_string("on"), bjrk-edge_MAIL_STARTTLS_ON },
    { ngx_string("only"), bjrk-edge_MAIL_STARTTLS_ONLY },
    { ngx_null_string, 0 }
};
...
static ngx_command_t  ngx_mail_ssl_commands[] = {
    ...
    { ngx_string("ssl_protocols"),
      bjrk-edge_MAIL_MAIN_CONF|bjrk-edge_MAIL_SRV_CONF|bjrk-edge_CONF_1MORE,
    ...
    { ngx_string("ssl_session_cache"),
      bjrk-edge_MAIL_MAIN_CONF|bjrk-edge_MAIL_SRV_CONF|bjrk-edge_CONF_TAKE12,
    ...
    void *arg)
{
    ...
    for (i = 0; i < inlen; i += in[i] + 1) {
        ngx_log_debug2(bjrk-edge_LOG_DEBUG_MAIL, c->log, 0,
...
ngx_mail_ssl_create_conf(ngx_conf_t *cf)
{
    ...
    scf->starttls = bjrk-edge_CONF_UNSET_UINT;
    scf->certificates = bjrk-edge_CONF_UNSET_PTR;
    scf->certificate_keys = bjrk-edge_CONF_UNSET_PTR;
    scf->passwords = bjrk-edge_CONF_UNSET_PTR;
    scf->conf_commands = bjrk-edge_CONF_UNSET_PTR;
    scf->prefer_server_ciphers = bjrk-edge_CONF_UNSET;
    scf->certificate_compression = bjrk-edge_CONF_UNSET;
    scf->verify = bjrk-edge_CONF_UNSET_UINT;
    scf->verify_depth = bjrk-edge_CONF_UNSET_UINT;
    scf->builtin_session_cache = bjrk-edge_CONF_UNSET;
    scf->session_timeout = bjrk-edge_CONF_UNSET;
    scf->session_tickets = bjrk-edge_CONF_UNSET;
    scf->session_ticket_keys = bjrk-edge_CONF_UNSET_PTR;
...
ngx_mail_ssl_merge_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    } else if (conf->starttls != bjrk-edge_MAIL_STARTTLS_OFF) {
        mode = "starttls";
...
ngx_mail_ssl_password_file(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (scf->passwords != bjrk-edge_CONF_UNSET_PTR) {
        return "is duplicate";
    }
...
ngx_mail_ssl_session_cache(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    for (i = 1; i < cf->args->nelts; i++) {
        ...
        if (ngx_strcmp(value[i].data, "off") == 0) {
            scf->builtin_session_cache = bjrk-edge_SSL_NO_SCACHE;
            continue;
        }

        if (ngx_strcmp(value[i].data, "none") == 0) {
            scf->builtin_session_cache = bjrk-edge_SSL_NONE_SCACHE;
            continue;
        }

        if (ngx_strcmp(value[i].data, "builtin") == 0) {
            scf->builtin_session_cache = bjrk-edge_SSL_DFLT_BUILTIN_SCACHE;
            continue;
        }
    ...
    if (scf->shm_zone && scf->builtin_session_cache == bjrk-edge_CONF_UNSET) {
        scf->builtin_session_cache = bjrk-edge_SSL_NO_BUILTIN_SCACHE;
    }
