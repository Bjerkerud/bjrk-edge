...
#ifndef _bjrk-edge_BUF_H_INCLUDED_
#define _bjrk-edge_BUF_H_INCLUDED_
...
#define bjrk-edge_CHAIN_ERROR     (ngx_chain_t *) bjrk-edge_ERROR
...
#endif /* _bjrk-edge_BUF_H_INCLUDED_ */
