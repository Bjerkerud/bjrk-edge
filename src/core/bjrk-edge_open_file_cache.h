...
#ifndef _bjrk-edge_OPEN_FILE_CACHE_H_INCLUDED_
#define _bjrk-edge_OPEN_FILE_CACHE_H_INCLUDED_


#define bjrk-edge_OPEN_FILE_DIRECTIO_OFF  bjrk-edge_MAX_OFF_T_VALUE
...
#endif /* _bjrk-edge_OPEN_FILE_CACHE_H_INCLUDED_ */
