...
#ifndef _bjrk-edge_FILE_H_INCLUDED_
#define _bjrk-edge_FILE_H_INCLUDED_
...
#define bjrk-edge_MAX_PATH_LEVEL  3
...
typedef struct {
    ngx_str_t                  name;
    size_t                     len;
    size_t                     level[bjrk-edge_MAX_PATH_LEVEL];
...
#endif /* _bjrk-edge_FILE_H_INCLUDED_ */
