...
static size_t  ngx_data_sizes[] = {
    sizeof(ngx_data_obj_t),            /* bjrk-edge_DATA_OBJECT_TYPE */
    sizeof(ngx_data_obj_t),            /* bjrk-edge_DATA_LIST_TYPE */
    sizeof(ngx_str_t),                 /* bjrk-edge_DATA_STRING_TYPE */
    sizeof(int64_t),                   /* bjrk-edge_DATA_INTEGER_TYPE */
    sizeof(ngx_uint_t),                /* bjrk-edge_DATA_BOOLEAN_TYPE */
    0,                                 /* bjrk-edge_DATA_NULL_TYPE */
};
...
ngx_data_add_item(ngx_data_item_t *obj, ngx_str_t *name, ngx_data_item_t *item)
{
    ...
    if (obj->type != bjrk-edge_DATA_OBJECT_TYPE && obj->type != bjrk-edge_DATA_LIST_TYPE) {
        return;
    }
...
ngx_data_obj_handler(uintptr_t data, ngx_pool_t *pool, void *ctx)
{
    ...
    while (decl->name.len) {
        ...
        if (item != bjrk-edge_DATA_DECLINE) {
