...
#ifndef _bjrk-edge_RADIX_TREE_H_INCLUDED_
#define _bjrk-edge_RADIX_TREE_H_INCLUDED_
...
#define bjrk-edge_RADIX_NO_VALUE   (uintptr_t) -1
...
#endif /* _bjrk-edge_RADIX_TREE_H_INCLUDED_ */
