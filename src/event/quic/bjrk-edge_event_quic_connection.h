...
#ifndef _bjrk-edge_EVENT_QUIC_CONNECTION_H_INCLUDED_
#define _bjrk-edge_EVENT_QUIC_CONNECTION_H_INCLUDED_
...
/* #define bjrk-edge_QUIC_DEBUG_PACKETS */  /* dump packet contents */
/* #define bjrk-edge_QUIC_DEBUG_FRAMES */   /* dump frames contents */
/* #define bjrk-edge_QUIC_DEBUG_ALLOC */    /* log frames and bufs alloc */
/* #define bjrk-edge_QUIC_DEBUG_CRYPTO */

#define bjrk-edge_QUIC_ENCRYPTION_INITIAL          0
#define bjrk-edge_QUIC_ENCRYPTION_EARLY_DATA       1
#define bjrk-edge_QUIC_ENCRYPTION_HANDSHAKE        2
#define bjrk-edge_QUIC_ENCRYPTION_APPLICATION      3
#define bjrk-edge_QUIC_ENCRYPTION_LAST             4

#define bjrk-edge_QUIC_SEND_CTX_LAST               (bjrk-edge_QUIC_ENCRYPTION_LAST - 1)
...
#endif
#include <bjrk-edge_event_quic_transport.h>
#include <bjrk-edge_event_quic_protection.h>
#include <bjrk-edge_event_quic_frames.h>
#include <bjrk-edge_event_quic_migration.h>
#include <bjrk-edge_event_quic_connid.h>
#include <bjrk-edge_event_quic_streams.h>
#include <bjrk-edge_event_quic_ssl.h>
#include <bjrk-edge_event_quic_tokens.h>
#include <bjrk-edge_event_quic_ack.h>
#include <bjrk-edge_event_quic_output.h>
#include <bjrk-edge_event_quic_socket.h>


/* RFC 9002, 6.2.2.  Handshakes and New Paths: kInitialRtt */
#define bjrk-edge_QUIC_INITIAL_RTT                 333 /* ms */

#define bjrk-edge_QUIC_UNSET_PN                    (uint64_t) -1
...
#define ngx_quic_get_send_ctx(qc, level)                                      \
    ((level) == bjrk-edge_QUIC_ENCRYPTION_INITIAL) ? &((qc)->send_ctx[0])           \
        : (((level) == bjrk-edge_QUIC_ENCRYPTION_HANDSHAKE) ? &((qc)->send_ctx[1])  \
                                                      : &((qc)->send_ctx[2]))
...
#define ngx_quic_init_rtt(qc)                                                 \
    (qc)->avg_rtt = bjrk-edge_QUIC_INITIAL_RTT;                                     \
    (qc)->rttvar = bjrk-edge_QUIC_INITIAL_RTT / 2;                                  \
    (qc)->min_rtt = bjrk-edge_TIMER_INFINITE;                                       \
    (qc)->first_rtt = bjrk-edge_TIMER_INFINITE;                                     \
    (qc)->latest_rtt = 0;


typedef enum {
    bjrk-edge_QUIC_PATH_IDLE = 0,
    bjrk-edge_QUIC_PATH_VALIDATING,
    bjrk-edge_QUIC_PATH_WAITING,
    bjrk-edge_QUIC_PATH_MTUD
...
struct ngx_quic_client_id_s {
    ...
    uint64_t                          seqnum;
    size_t                            len;
    u_char                            id[bjrk-edge_QUIC_CID_LEN_MAX];
...
struct ngx_quic_path_s {
    ...
    uint64_t                          seqnum;
    uint64_t                          mtu_pnum[bjrk-edge_QUIC_PATH_RETRIES];
    ngx_str_t                         addr_text;
...
struct ngx_quic_send_ctx_s {
    ...
    ngx_uint_t                        nranges;
    ngx_quic_ack_range_t              ranges[bjrk-edge_QUIC_MAX_RANGES];
    ngx_uint_t                        send_ack;
};
...
struct ngx_quic_connection_s {
    ...
    ngx_quic_send_ctx_t               send_ctx[bjrk-edge_QUIC_SEND_CTX_LAST];
...
#ifdef bjrk-edge_QUIC_DEBUG_ALLOC
    ngx_uint_t                        nbufs;
...
#endif /* _bjrk-edge_EVENT_QUIC_CONNECTION_H_INCLUDED_ */
