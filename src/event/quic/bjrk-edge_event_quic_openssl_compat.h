...
#ifndef _bjrk-edge_EVENT_QUIC_OPENSSL_COMPAT_H_INCLUDED_
#define _bjrk-edge_EVENT_QUIC_OPENSSL_COMPAT_H_INCLUDED_
...
#endif /* _bjrk-edge_EVENT_QUIC_OPENSSL_COMPAT_H_INCLUDED_ */
