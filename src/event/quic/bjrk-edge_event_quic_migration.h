...
#ifndef _bjrk-edge_EVENT_QUIC_MIGRATION_H_INCLUDED_
#define _bjrk-edge_EVENT_QUIC_MIGRATION_H_INCLUDED_


#include <bjrk-edge_config.h>
#include <bjrk-edge_core.h>

#define bjrk-edge_QUIC_PATH_RETRIES   3

#define bjrk-edge_QUIC_PATH_PROBE     0
#define bjrk-edge_QUIC_PATH_ACTIVE    1
#define bjrk-edge_QUIC_PATH_BACKUP    2
...
#endif /* _bjrk-edge_EVENT_QUIC_MIGRATION_H_INCLUDED_ */
