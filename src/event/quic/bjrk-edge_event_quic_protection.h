...
#ifndef _bjrk-edge_EVENT_QUIC_PROTECTION_H_INCLUDED_
#define _bjrk-edge_EVENT_QUIC_PROTECTION_H_INCLUDED_
...
#define bjrk-edge_QUIC_IV_LEN               12
#define bjrk-edge_QUIC_TAG_LEN              16

/* largest hash used in TLS is SHA-384 */
#define bjrk-edge_QUIC_MAX_MD_SIZE          48


#if (defined OPENSSL_IS_BORINGSSL || defined OPENSSL_IS_AWSLC)
#define bjrk-edge_QUIC_BORINGSSL_EVP_API    1
#define ngx_quic_cipher_t             EVP_AEAD
#define ngx_quic_crypto_ctx_t         EVP_AEAD_CTX
#else
#define bjrk-edge_QUIC_BORINGSSL_EVP_API    0
...
typedef struct {
    size_t                    len;
    u_char                    data[bjrk-edge_QUIC_MAX_MD_SIZE];
} ngx_quic_md_t;


typedef struct {
    size_t                    len;
    u_char                    data[bjrk-edge_QUIC_IV_LEN];
} ngx_quic_iv_t;
...
struct ngx_quic_keys_s {
    ngx_quic_secrets_t        secrets[bjrk-edge_QUIC_ENCRYPTION_LAST];
...
#endif /* _bjrk-edge_EVENT_QUIC_PROTECTION_H_INCLUDED_ */
