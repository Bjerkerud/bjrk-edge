...
#if (bjrk-edge_TEST_BUILD_EVENTPORT)
...
#if (__FreeBSD__ && __FreeBSD_version < 700005) || (bjrk-edge_DARWIN)
...
ngx_eventport_init(ngx_cycle_t *cycle, ngx_msec_t timer)
{
    ...
    ngx_event_flags = bjrk-edge_USE_EVENTPORT_EVENT;
    ...
    ngx_uint_t flags)
{
    ...
    if (n == -1) {
        ...
        level = (err == bjrk-edge_EINTR) ? bjrk-edge_LOG_INFO : bjrk-edge_LOG_ALERT;
