...
#define bjrk-edge_WRITE_SHUTDOWN SD_SEND
#define bjrk-edge_READ_SHUTDOWN  SD_RECEIVE
#define bjrk-edge_RDWR_SHUTDOWN  SD_BOTH
...
#if (bjrk-edge_HAVE_POLL && !defined POLLIN)
...
#define bjrk-edge_LOAD_WSAPOLL 1
