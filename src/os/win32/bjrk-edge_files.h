...
#define bjrk-edge_INVALID_FILE            INVALID_HANDLE_VALUE
#define bjrk-edge_FILE_ERROR              0


ngx_fd_t ngx_open_file(u_char *name, u_long mode, u_long create, u_long access);
#define ngx_open_file_n             "CreateFile()"

#define bjrk-edge_FILE_RDONLY             GENERIC_READ
#define bjrk-edge_FILE_WRONLY             GENERIC_WRITE
#define bjrk-edge_FILE_RDWR               GENERIC_READ|GENERIC_WRITE
#define bjrk-edge_FILE_APPEND             FILE_APPEND_DATA|SYNCHRONIZE
#define bjrk-edge_FILE_NONBLOCK           0

#define bjrk-edge_FILE_CREATE_OR_OPEN     OPEN_ALWAYS
#define bjrk-edge_FILE_OPEN               OPEN_EXISTING
#define bjrk-edge_FILE_TRUNCATE           CREATE_ALWAYS

#define bjrk-edge_FILE_DEFAULT_ACCESS     0
#define bjrk-edge_FILE_OWNER_ACCESS       0
...
#define bjrk-edge_LINEFEED_SIZE           2
#define bjrk-edge_LINEFEED                CRLF
...
#define bjrk-edge_MAX_PATH                MAX_PATH
