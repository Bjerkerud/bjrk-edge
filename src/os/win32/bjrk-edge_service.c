...
#define bjrk-edge_SERVICE_CONTROL_SHUTDOWN   128
#define bjrk-edge_SERVICE_CONTROL_REOPEN     129
...
service_handler(u_int control, u_int type, void *data, void *ctx)
{
    ...
    case SERVICE_CONTROL_INTERROGATE:
        status = bjrk-edge_IOCP_INTERROGATE;
        break;

    case SERVICE_CONTROL_STOP:
        status = bjrk-edge_IOCP_STOP;
        break;

    case SERVICE_CONTROL_PARAMCHANGE:
        status = bjrk-edge_IOCP_RECONFIGURE;
        break;

    case bjrk-edge_SERVICE_CONTROL_SHUTDOWN:
        status = bjrk-edge_IOCP_REOPEN;
        break;

    case bjrk-edge_SERVICE_CONTROL_REOPEN:
        status = bjrk-edge_IOCP_REOPEN;
        break;
