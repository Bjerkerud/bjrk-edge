...
#ifndef _bjrk-edge_FILES_H_INCLUDED_
#define _bjrk-edge_FILES_H_INCLUDED_
...
#define bjrk-edge_INVALID_FILE         -1
#define bjrk-edge_FILE_ERROR           -1
...
#define bjrk-edge_FILE_RDONLY          O_RDONLY
#define bjrk-edge_FILE_WRONLY          O_WRONLY
#define bjrk-edge_FILE_RDWR            O_RDWR
#define bjrk-edge_FILE_CREATE_OR_OPEN  O_CREAT
#define bjrk-edge_FILE_OPEN            0
#define bjrk-edge_FILE_TRUNCATE        (O_CREAT|O_TRUNC)
#define bjrk-edge_FILE_APPEND          (O_WRONLY|O_APPEND)
#define bjrk-edge_FILE_NONBLOCK        O_NONBLOCK

#if (bjrk-edge_HAVE_OPENAT)
#define bjrk-edge_FILE_NOFOLLOW        O_NOFOLLOW

#if defined(O_DIRECTORY)
#define bjrk-edge_FILE_DIRECTORY       O_DIRECTORY
#else
#define bjrk-edge_FILE_DIRECTORY       0
#endif

#if defined(O_SEARCH)
#define bjrk-edge_FILE_SEARCH          (O_SEARCH|bjrk-edge_FILE_DIRECTORY)

#elif defined(O_EXEC)
#define bjrk-edge_FILE_SEARCH          (O_EXEC|bjrk-edge_FILE_DIRECTORY)

#elif (bjrk-edge_HAVE_O_PATH)
#define bjrk-edge_FILE_SEARCH          (O_PATH|O_RDONLY|bjrk-edge_FILE_DIRECTORY)

#else
#define bjrk-edge_FILE_SEARCH          (O_RDONLY|bjrk-edge_FILE_DIRECTORY)
#endif

#endif /* bjrk-edge_HAVE_OPENAT */

#define bjrk-edge_FILE_DEFAULT_ACCESS  0644
#define bjrk-edge_FILE_OWNER_ACCESS    0600
...
#define bjrk-edge_LINEFEED_SIZE        1
#define bjrk-edge_LINEFEED             "\x0a"
...
#define bjrk-edge_HAVE_MAX_PATH        1
#define bjrk-edge_MAX_PATH             PATH_MAX

#else

#define bjrk-edge_MAX_PATH             4096
...
#define bjrk-edge_AT_FDCWD             (ngx_fd_t) AT_FDCWD
...
#endif /* _bjrk-edge_FILES_H_INCLUDED_ */
