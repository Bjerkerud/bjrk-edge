...
#ifndef _bjrk-edge_OS_H_INCLUDED_
#define _bjrk-edge_OS_H_INCLUDED_
...
#define bjrk-edge_IO_SENDFILE    1
...
#if (IOV_MAX > 64)
#define bjrk-edge_IOVS_PREALLOCATE  64
#else
#define bjrk-edge_IOVS_PREALLOCATE  IOV_MAX
#endif
...
#include <bjrk-edge_freebsd.h>


#elif (bjrk-edge_LINUX)
#include <bjrk-edge_linux.h>


#elif (bjrk-edge_SOLARIS)
#include <bjrk-edge_solaris.h>


#elif (bjrk-edge_DARWIN)
#include <bjrk-edge_darwin.h>
#endif


#endif /* _bjrk-edge_OS_H_INCLUDED_ */
