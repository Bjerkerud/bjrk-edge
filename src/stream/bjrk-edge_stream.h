...
#ifndef _bjrk-edge_STREAM_H_INCLUDED_
#define _bjrk-edge_STREAM_H_INCLUDED_
...
#include <bjrk-edge_stream_ssl_module.h>
#endif
...
#include <bjrk-edge_stream_variables.h>
#include <bjrk-edge_stream_script.h>
#include <bjrk-edge_stream_upstream.h>
#include <bjrk-edge_stream_upstream_round_robin.h>


#define bjrk-edge_STREAM_OK                        200
#define bjrk-edge_STREAM_BAD_REQUEST               400
#define bjrk-edge_STREAM_FORBIDDEN                 403
#define bjrk-edge_STREAM_INTERNAL_SERVER_ERROR     500
#define bjrk-edge_STREAM_BAD_GATEWAY               502
#define bjrk-edge_STREAM_SERVICE_UNAVAILABLE       503
...
typedef enum {
    bjrk-edge_STREAM_POST_ACCEPT_PHASE = 0,
    bjrk-edge_STREAM_PREACCESS_PHASE,
    bjrk-edge_STREAM_ACCESS_PHASE,
    bjrk-edge_STREAM_SSL_PHASE,
    bjrk-edge_STREAM_PREREAD_PHASE,
    bjrk-edge_STREAM_CONTENT_PHASE,
    bjrk-edge_STREAM_LOG_PHASE
} ngx_stream_phases;
...
typedef struct {
    ...
    ngx_stream_phase_t             phases[bjrk-edge_STREAM_LOG_PHASE + 1];
...
#define bjrk-edge_STREAM_MODULE       0x4d525453     /* "STRM" */

#define bjrk-edge_STREAM_MAIN_CONF    0x02000000
#define bjrk-edge_STREAM_SRV_CONF     0x04000000
#define bjrk-edge_STREAM_UPS_CONF     0x08000000


#define bjrk-edge_STREAM_MAIN_CONF_OFFSET  offsetof(ngx_stream_conf_ctx_t, main_conf)
#define bjrk-edge_STREAM_SRV_CONF_OFFSET   offsetof(ngx_stream_conf_ctx_t, srv_conf)
...
#define bjrk-edge_STREAM_WRITE_BUFFERED  0x10
...
#endif /* _bjrk-edge_STREAM_H_INCLUDED_ */
