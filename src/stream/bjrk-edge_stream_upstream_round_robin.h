...
#ifndef _bjrk-edge_STREAM_UPSTREAM_ROUND_ROBIN_H_INCLUDED_
#define _bjrk-edge_STREAM_UPSTREAM_ROUND_ROBIN_H_INCLUDED_
...
#define bjrk-edge_STREAM_UPSTREAM_FAILED      1
...
#if (bjrk-edge_STREAM_UPSTREAM_LEAST_TIME || bjrk-edge_COMPAT)
...
#define ngx_stream_upstream_rr_peer_unlock(peers, peer)
#define ngx_stream_upstream_rr_peer_ref(peers, peer)
#define ngx_stream_upstream_rr_peer_unref(peers, peer)  bjrk-edge_OK
...
#endif /* _bjrk-edge_STREAM_UPSTREAM_ROUND_ROBIN_H_INCLUDED_ */
