...
static ngx_stream_variable_t  ngx_stream_ssl_vars[] = {
    ...
    { ngx_string("ssl_protocol"), NULL, ngx_stream_ssl_static_variable,
      (uintptr_t) ngx_ssl_get_protocol, bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_cipher"), NULL, ngx_stream_ssl_static_variable,
      (uintptr_t) ngx_ssl_get_cipher_name, bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_ciphers"), NULL, ngx_stream_ssl_variable,
      (uintptr_t) ngx_ssl_get_ciphers, bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_curve"), NULL, ngx_stream_ssl_variable,
      (uintptr_t) ngx_ssl_get_curve, bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_curves"), NULL, ngx_stream_ssl_variable,
      (uintptr_t) ngx_ssl_get_curves, bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_sigalg"), NULL, ngx_stream_ssl_variable,
      (uintptr_t) ngx_ssl_get_sigalg, bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_sigalgs"), NULL, ngx_stream_ssl_variable,
      (uintptr_t) ngx_ssl_get_sigalgs, bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_session_id"), NULL, ngx_stream_ssl_variable,
      (uintptr_t) ngx_ssl_get_session_id, bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_session_reused"), NULL, ngx_stream_ssl_variable,
      (uintptr_t) ngx_ssl_get_session_reused, bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_server_name"), NULL, ngx_stream_ssl_variable,
      (uintptr_t) ngx_ssl_get_server_name, bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_alpn_protocol"), NULL, ngx_stream_ssl_variable,
      (uintptr_t) ngx_ssl_get_alpn_protocol, bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_ech_status"), NULL, ngx_stream_ssl_variable,
      (uintptr_t) ngx_ssl_get_ech_status, bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_ech_outer_server_name"), NULL, ngx_stream_ssl_variable,
      (uintptr_t) ngx_ssl_get_ech_outer_server_name,
      bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_client_cert"), NULL, ngx_stream_ssl_variable,
      (uintptr_t) ngx_ssl_get_certificate, bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },
    ...
    { ngx_string("ssl_client_s_dn"), NULL, ngx_stream_ssl_variable,
      (uintptr_t) ngx_ssl_get_subject_dn, bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_client_i_dn"), NULL, ngx_stream_ssl_variable,
      (uintptr_t) ngx_ssl_get_issuer_dn, bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_client_serial"), NULL, ngx_stream_ssl_variable,
      (uintptr_t) ngx_ssl_get_serial_number, bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_client_fingerprint"), NULL, ngx_stream_ssl_variable,
      (uintptr_t) ngx_ssl_get_fingerprint, bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_client_verify"), NULL, ngx_stream_ssl_variable,
      (uintptr_t) ngx_ssl_get_client_verify, bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_client_v_start"), NULL, ngx_stream_ssl_variable,
      (uintptr_t) ngx_ssl_get_client_v_start, bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_client_v_end"), NULL, ngx_stream_ssl_variable,
      (uintptr_t) ngx_ssl_get_client_v_end, bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_client_v_remain"), NULL, ngx_stream_ssl_variable,
      (uintptr_t) ngx_ssl_get_client_v_remain, bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_client_sigalg"), NULL, ngx_stream_ssl_variable,
      (uintptr_t) ngx_ssl_get_client_sigalg, bjrk-edge_STREAM_VAR_CHANGEABLE, 0 },
...
ngx_stream_ssl_init_connection(ngx_ssl_t *ssl, ngx_connection_t *c)
{
    ...
    if (cscf->tcp_nodelay && ngx_tcp_nodelay(c) != bjrk-edge_OK) {
        return bjrk-edge_ERROR;
    }

    if (ngx_ssl_create_connection(ssl, c, 0) != bjrk-edge_OK) {
        return bjrk-edge_ERROR;
    }
...
ngx_stream_ssl_handshake_handler(ngx_connection_t *c)
{
    ...
    if (!c->ssl->handshaked) {
        ngx_stream_finalize_session(s, bjrk-edge_STREAM_INTERNAL_SERVER_ERROR);
        return;
    }
    ...
    void *arg)
{
    ...
    for (i = 0; i < inlen; i += in[i] + 1) {
        ngx_log_debug2(bjrk-edge_LOG_DEBUG_STREAM, c->log, 0,
...
ngx_stream_ssl_certificate(ngx_ssl_conn_t *ssl_conn, void *arg)
{
    ...
    for (i = 0; i < nelts; i++) {
        ...
        if (ngx_stream_complex_value(s, &certs[i], &cert) != bjrk-edge_OK) {
            return 0;
        }
        ...
        if (ngx_stream_complex_value(s, &keys[i], &key) != bjrk-edge_OK) {
            return 0;
        }
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    if (s->connection->ssl) {
        ...
        if (handler(s->connection, s->connection->pool, &str) != bjrk-edge_OK) {
            return bjrk-edge_ERROR;
        }
...
ngx_stream_ssl_create_srv_conf(ngx_conf_t *cf)
{
    ...
    sscf->handshake_timeout = bjrk-edge_CONF_UNSET_MSEC;
...
ngx_stream_ssl_merge_srv_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (ngx_ssl_create(&conf->ssl, conf->protocols, NULL) != bjrk-edge_OK) {
        return bjrk-edge_CONF_ERROR;
    }
    ...
    if (ngx_stream_ssl_compile_certificates(cf, conf) != bjrk-edge_OK) {
        return bjrk-edge_CONF_ERROR;
    }
...
ngx_stream_ssl_init(ngx_conf_t *cf)
{
    ...
    h = ngx_array_push(&cmcf->phases[bjrk-edge_STREAM_SSL_PHASE].handlers);
    if (h == NULL) {
        return bjrk-edge_ERROR;
    }
