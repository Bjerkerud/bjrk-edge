...
static ngx_command_t  ngx_stream_upstream_random_commands[] = {
    ...
    { ngx_string("random"),
      bjrk-edge_STREAM_UPS_CONF|bjrk-edge_CONF_NOARGS|bjrk-edge_CONF_TAKE12,
...
ngx_stream_upstream_init_random(ngx_conf_t *cf,
    ngx_stream_upstream_srv_conf_t *us)
{
    ngx_log_debug0(bjrk-edge_LOG_DEBUG_STREAM, cf->log, 0, "init random");
    ...
    ngx_stream_upstream_srv_conf_t *us)
{
    ...
    {
        if (ngx_stream_upstream_update_random(NULL, us) != bjrk-edge_OK) {
