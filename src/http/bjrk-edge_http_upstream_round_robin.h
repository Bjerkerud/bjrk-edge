...
#ifndef _bjrk-edge_HTTP_UPSTREAM_ROUND_ROBIN_H_INCLUDED_
#define _bjrk-edge_HTTP_UPSTREAM_ROUND_ROBIN_H_INCLUDED_
...
#define bjrk-edge_HTTP_UPSTREAM_SID_LEN    32  /* md5 in hex */
#endif

#define bjrk-edge_HTTP_UPSTREAM_FAILED     1

#if (bjrk-edge_HTTP_UPSTREAM_STICKY)
#define bjrk-edge_HTTP_UPSTREAM_DRAINING   8
#endif
...
#if (bjrk-edge_HTTP_UPSTREAM_LEAST_TIME || bjrk-edge_COMPAT)
...
#define ngx_http_upstream_rr_peer_unlock(peers, peer)
#define ngx_http_upstream_rr_peer_ref(peers, peer)
#define ngx_http_upstream_rr_peer_unref(peers, peer)  bjrk-edge_OK
...
#endif /* _bjrk-edge_HTTP_UPSTREAM_ROUND_ROBIN_H_INCLUDED_ */
