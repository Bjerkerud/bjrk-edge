    ...
    ngx_http_client_body_handler_pt post_handler)
{
    ...
    if (ngx_http_test_expect(r) != bjrk-edge_OK) {
    ...
    if (r->request_body_no_buffering
        && (rc == bjrk-edge_OK || rc == bjrk-edge_AGAIN))
    {
        if (rc == bjrk-edge_OK) {
            r->request_body_no_buffering = 0;
...
ngx_http_do_read_client_request_body(ngx_http_request_t *r)
{
    ...
    if (ngx_http_copy_pipelined_header(r, rb->buf) != bjrk-edge_OK) {
        return bjrk-edge_HTTP_INTERNAL_SERVER_ERROR;
    }
...
ngx_http_discard_request_body(ngx_http_request_t *r)
{
    ...
    ngx_log_debug0(bjrk-edge_LOG_DEBUG_HTTP, rev->log, 0, "http set discard body");
...
ngx_http_read_discarded_request_body(ngx_http_request_t *r)
{
    ...
    ngx_int_t  rc;
    ngx_buf_t  b;
    u_char     buffer[bjrk-edge_HTTP_DISCARD_BUFFER_SIZE];
    ...
    for ( ;; ) {
        ...
        size = (size_t) ngx_min(r->headers_in.content_length_n,
                                bjrk-edge_HTTP_DISCARD_BUFFER_SIZE);
    ...
    if (ngx_http_copy_pipelined_header(r, &b) != bjrk-edge_OK) {
        return bjrk-edge_HTTP_INTERNAL_SERVER_ERROR;
    }
...
ngx_http_test_expect(ngx_http_request_t *r)
{
    ...
    if (r->expect_tested
        ...
        || r->http_version < bjrk-edge_HTTP_VERSION_11
#if (bjrk-edge_HTTP_V2)
        || r->stream != NULL
#endif
#if (bjrk-edge_HTTP_V3)
    ...
    *ll = NULL;
    ...
    if (rb->rest > 0) {
        ...
        if (rb->bufs && rb->buf && rb->buf->last == rb->buf->end
            && ngx_http_write_request_body(r) != bjrk-edge_OK)
        {
            return bjrk-edge_HTTP_INTERNAL_SERVER_ERROR;
        }
    ...
    if (rb->temp_file || r->request_body_in_file_only) {
        ...
        if (ngx_http_write_request_body(r) != bjrk-edge_OK) {
            return bjrk-edge_HTTP_INTERNAL_SERVER_ERROR;
        }
