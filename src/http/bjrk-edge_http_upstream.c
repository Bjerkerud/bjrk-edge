...
static ngx_command_t  ngx_http_upstream_commands[] = {
    ...
    { ngx_string("upstream"),
      bjrk-edge_HTTP_MAIN_CONF|bjrk-edge_CONF_BLOCK|bjrk-edge_CONF_TAKE1,
      ngx_http_upstream,
      0,
      0,
      NULL },
    ...
    { ngx_string("server"),
      bjrk-edge_HTTP_UPS_CONF|bjrk-edge_CONF_1MORE,
    ...
    { ngx_string("resolver_timeout"),
      bjrk-edge_HTTP_UPS_CONF|bjrk-edge_CONF_TAKE1,
...
static ngx_http_variable_t  ngx_http_upstream_vars[] = {
    ...
    { ngx_string("upstream_addr"), NULL,
      ...
      bjrk-edge_HTTP_VAR_NOCACHEABLE, 0 },
    ...
    { ngx_string("upstream_cache_last_modified"), NULL,
      ...
      bjrk-edge_HTTP_VAR_NOCACHEABLE|bjrk-edge_HTTP_VAR_NOHASH, 0 },
    ...
    { ngx_string("upstream_http_"), NULL, ngx_http_upstream_header_variable,
      0, bjrk-edge_HTTP_VAR_NOCACHEABLE|bjrk-edge_HTTP_VAR_PREFIX, 0 },
...
static ngx_http_upstream_next_t  ngx_http_upstream_next_errors[] = {
    { 500, bjrk-edge_HTTP_UPSTREAM_FT_HTTP_500 },
    { 502, bjrk-edge_HTTP_UPSTREAM_FT_HTTP_502 },
    { 503, bjrk-edge_HTTP_UPSTREAM_FT_HTTP_503 },
    { 504, bjrk-edge_HTTP_UPSTREAM_FT_HTTP_504 },
    { 403, bjrk-edge_HTTP_UPSTREAM_FT_HTTP_403 },
    { 404, bjrk-edge_HTTP_UPSTREAM_FT_HTTP_404 },
    { 429, bjrk-edge_HTTP_UPSTREAM_FT_HTTP_429 },
    { 0, 0 }
};


ngx_conf_bitmask_t  ngx_http_upstream_cache_method_mask[] = {
    { ngx_string("GET"), bjrk-edge_HTTP_GET },
    { ngx_string("HEAD"), bjrk-edge_HTTP_HEAD },
    { ngx_string("POST"), bjrk-edge_HTTP_POST },
    { ngx_null_string, 0 }
};


ngx_conf_bitmask_t  ngx_http_upstream_ignore_headers_masks[] = {
    { ngx_string("X-Accel-Redirect"), bjrk-edge_HTTP_UPSTREAM_IGN_XA_REDIRECT },
    { ngx_string("X-Accel-Expires"), bjrk-edge_HTTP_UPSTREAM_IGN_XA_EXPIRES },
    { ngx_string("X-Accel-Limit-Rate"), bjrk-edge_HTTP_UPSTREAM_IGN_XA_LIMIT_RATE },
    { ngx_string("X-Accel-Buffering"), bjrk-edge_HTTP_UPSTREAM_IGN_XA_BUFFERING },
    { ngx_string("X-Accel-Charset"), bjrk-edge_HTTP_UPSTREAM_IGN_XA_CHARSET },
    { ngx_string("Expires"), bjrk-edge_HTTP_UPSTREAM_IGN_EXPIRES },
    { ngx_string("Cache-Control"), bjrk-edge_HTTP_UPSTREAM_IGN_CACHE_CONTROL },
    { ngx_string("Set-Cookie"), bjrk-edge_HTTP_UPSTREAM_IGN_SET_COOKIE },
    { ngx_string("Vary"), bjrk-edge_HTTP_UPSTREAM_IGN_VARY },
    { ngx_null_string, 0 }
};
...
ngx_http_upstream_init(ngx_http_request_t *r)
{
    ...
    ngx_log_debug1(bjrk-edge_LOG_DEBUG_HTTP, c->log, 0,
    ...
    if (ngx_event_flags & bjrk-edge_USE_CLEAR_EVENT) {

        if (!c->write->active) {
            if (ngx_add_event(c->write, bjrk-edge_WRITE_EVENT, bjrk-edge_CLEAR_EVENT)
                == bjrk-edge_ERROR)
            {
...
ngx_http_upstream_init_request(ngx_http_request_t *r)
{
    ...
    if (u->conf->cache) {
        ...
        if (rc == bjrk-edge_OK) {
            ...
            if (rc == bjrk-edge_HTTP_UPSTREAM_INVALID_HEADER) {
                rc = bjrk-edge_DECLINED;
                r->cached = 0;
                u->buffer.start = NULL;
                u->cache_status = bjrk-edge_HTTP_CACHE_MISS;
                u->request_sent = 1;
            }
        }
    ...
    if (u->create_request(r) != bjrk-edge_OK) {
        ngx_http_finalize_request(r, bjrk-edge_HTTP_INTERNAL_SERVER_ERROR);
        return;
    }

    if (ngx_http_upstream_set_local(r, u, u->conf->local) != bjrk-edge_OK) {
        ngx_http_finalize_request(r, bjrk-edge_HTTP_INTERNAL_SERVER_ERROR);
        return;
    }
    ...
    if (r->upstream_states == NULL) {
        ...
        if (u->state == NULL) {
            ngx_http_upstream_finalize_request(r, u,
                                               bjrk-edge_HTTP_INTERNAL_SERVER_ERROR);
            return;
        }
    ...
    if (u->resolved == NULL) {
        ...
        if (ctx == bjrk-edge_NO_RESOLVER) {
            ...
            ngx_http_upstream_finalize_request(r, u, bjrk-edge_HTTP_BAD_GATEWAY);
            return;
        }
...
found:
    ...
    if (uscf->peer.init(r, uscf) != bjrk-edge_OK) {
        ngx_http_upstream_finalize_request(r, u,
                                           bjrk-edge_HTTP_INTERNAL_SERVER_ERROR);
        return;
    }
...
ngx_http_upstream_cache(ngx_http_request_t *r, ngx_http_upstream_t *u)
{
    ...
    if (c == NULL) {
        ...
        if (r->method == bjrk-edge_HTTP_HEAD && u->conf->cache_convert_head) {
            u->method = ngx_http_core_get_method;
        }

        if (ngx_http_file_cache_new(r) != bjrk-edge_OK) {
            return bjrk-edge_ERROR;
        }

        if (u->create_key(r) != bjrk-edge_OK) {
            return bjrk-edge_ERROR;
        }
        ...
        case bjrk-edge_ERROR:
            return bjrk-edge_ERROR;

        case bjrk-edge_DECLINED:
            u->cache_status = bjrk-edge_HTTP_CACHE_BYPASS;
            return bjrk-edge_DECLINED;

        default: /* bjrk-edge_OK */
            break;
        }
    ...
    case bjrk-edge_HTTP_CACHE_STALE:

        if (((u->conf->cache_use_stale & bjrk-edge_HTTP_UPSTREAM_FT_UPDATING)
             || c->stale_updating) && !r->background
            && u->conf->cache_background_update)
        {
            if (ngx_http_upstream_cache_background_update(r, u) == bjrk-edge_OK) {
    ...
    case bjrk-edge_HTTP_CACHE_UPDATING:
             ...
             || c->stale_updating) && !r->background)
        {
            ...
            rc = bjrk-edge_HTTP_CACHE_STALE;
        }

        break;

    case bjrk-edge_OK:
        u->cache_status = bjrk-edge_HTTP_CACHE_HIT;
    }
    ...
    case bjrk-edge_HTTP_CACHE_STALE:
        ...
        u->buffer.start = NULL;
        u->cache_status = bjrk-edge_HTTP_CACHE_EXPIRED;
    ...
    case bjrk-edge_HTTP_CACHE_SCARCE:

        u->cacheable = 0;

        break;

    case bjrk-edge_AGAIN:
    ...
    default:
        ...
        /* cached bjrk-edge_HTTP_BAD_GATEWAY, bjrk-edge_HTTP_GATEWAY_TIME_OUT, etc. */
    ...
    if (ngx_http_upstream_cache_check_range(r, u) == bjrk-edge_DECLINED) {
        u->cacheable = 0;
    }
    ...
    ngx_http_file_cache_t **cache)
{
    ...
    if (ngx_http_complex_value(r, u->conf->cache_value, &val) != bjrk-edge_OK) {
        return bjrk-edge_ERROR;
    }
...
ngx_http_upstream_cache_send(ngx_http_request_t *r, ngx_http_upstream_t *u)
{
    ...
    if (c->header_start == c->body_start) {
        r->http_version = bjrk-edge_HTTP_VERSION_9;
    ...
    if (rc == bjrk-edge_OK) {
        ...
        if (ngx_http_upstream_process_headers(r, u) != bjrk-edge_OK) {
    ...
    if (rc == bjrk-edge_AGAIN || rc == bjrk-edge_HTTP_UPSTREAM_EARLY_HINTS) {
        rc = bjrk-edge_HTTP_UPSTREAM_INVALID_HEADER;
    }
    ...
    ngx_http_upstream_t *u)
{
    ...
    if (ngx_http_subrequest(r, &r->uri, &r->args, &sr, NULL,
                            bjrk-edge_HTTP_SUBREQUEST_CLONE
                            |bjrk-edge_HTTP_SUBREQUEST_BACKGROUND)
        != bjrk-edge_OK)
    {
        return bjrk-edge_ERROR;
    }
    ...
    ngx_http_upstream_t *u)
{
    ...
    if (h == NULL
        || !u->cacheable
        || u->conf->cache_max_range_offset == bjrk-edge_MAX_OFF_T_VALUE)
    {
        return bjrk-edge_OK;
    }
...
ngx_http_upstream_resolve_handler(ngx_resolver_ctx_t *ctx)
{
    ...
    if (ngx_http_upstream_create_round_robin_peer(r, ur) != bjrk-edge_OK) {
        ngx_http_upstream_finalize_request(r, u,
                                           bjrk-edge_HTTP_INTERNAL_SERVER_ERROR);
        goto failed;
    }
    ...
    ngx_event_t *ev)
{
    ...
    ngx_log_debug2(bjrk-edge_LOG_DEBUG_HTTP, ev->log, 0,
    ...
    if (c->error) {
        if ((ngx_event_flags & bjrk-edge_USE_LEVEL_EVENT) && ev->active) {

            event = ev->write ? bjrk-edge_WRITE_EVENT : bjrk-edge_READ_EVENT;

            if (ngx_del_event(ev, event, 0) != bjrk-edge_OK) {
                ngx_http_upstream_finalize_request(r, u,
                                               bjrk-edge_HTTP_INTERNAL_SERVER_ERROR);
                return;
            }
        ...
        if (!u->cacheable) {
            ngx_http_upstream_finalize_request(r, u,
                                               bjrk-edge_HTTP_CLIENT_CLOSED_REQUEST);
        }
    ...
    if (ngx_event_flags & bjrk-edge_USE_KQUEUE_EVENT) {
        ...
        if (!u->cacheable && u->peer.connection) {
            ngx_log_error(bjrk-edge_LOG_INFO, ev->log, ev->kq_errno,
    ...
    if ((ngx_event_flags & bjrk-edge_USE_EPOLL_EVENT) && ngx_use_epoll_rdhup) {
        socklen_t  len;
        ...
        if (!u->cacheable && u->peer.connection) {
            ngx_log_error(bjrk-edge_LOG_INFO, ev->log, err,
    ...
    ngx_log_debug1(bjrk-edge_LOG_DEBUG_HTTP, ev->log, err,
                   "http upstream recv(): %d", n);

    if (ev->write && (n >= 0 || err == bjrk-edge_EAGAIN)) {
        return;
    }
...
ngx_http_upstream_connect(ngx_http_request_t *r, ngx_http_upstream_t *u)
{
    ...
    if (u->upstream && u->upstream->shm_zone
        && (u->upstream->flags & bjrk-edge_HTTP_UPSTREAM_MODIFY))
    {
    ...
    if (rc == bjrk-edge_BUSY) {
        ngx_log_error(bjrk-edge_LOG_ERR, r->connection->log, 0, "no live upstreams");
        ngx_http_upstream_next(r, u, bjrk-edge_HTTP_UPSTREAM_FT_NOLIVE);
        return;
    }

    if (rc == bjrk-edge_DECLINED) {
        ngx_http_upstream_next(r, u, bjrk-edge_HTTP_UPSTREAM_FT_ERROR);
        return;
    }
    ...
    if (r->connection->tcp_nopush == bjrk-edge_TCP_NOPUSH_DISABLED) {
        c->tcp_nopush = bjrk-edge_TCP_NOPUSH_DISABLED;
    }
    ...
    if (u->request_sent || u->response_received) {
        if (ngx_http_upstream_reinit(r, u) != bjrk-edge_OK) {
            ngx_http_upstream_finalize_request(r, u,
                                               bjrk-edge_HTTP_INTERNAL_SERVER_ERROR);
            return;
        }
    ...
    ngx_http_upstream_t *u, ngx_connection_t *c)
{
    ...
    if (ngx_http_upstream_test_connect(c) != bjrk-edge_OK) {
        ngx_http_upstream_next(r, u, bjrk-edge_HTTP_UPSTREAM_FT_ERROR);
        return;
    }

    if (ngx_ssl_create_connection(u->conf->ssl, c,
                                  bjrk-edge_SSL_BUFFER|bjrk-edge_SSL_CLIENT)
        != bjrk-edge_OK)
    {
        ngx_http_upstream_finalize_request(r, u,
                                           bjrk-edge_HTTP_INTERNAL_SERVER_ERROR);
    ...
    if (u->conf->ssl_server_name || u->conf->ssl_verify) {
        if (ngx_http_upstream_ssl_name(r, u, c) != bjrk-edge_OK) {
            ngx_http_upstream_finalize_request(r, u,
                                               bjrk-edge_HTTP_INTERNAL_SERVER_ERROR);
            return;
        }
    ...
    {
        if (ngx_http_upstream_ssl_certificate(r, u, c) != bjrk-edge_OK) {
            ngx_http_upstream_finalize_request(r, u,
                                               bjrk-edge_HTTP_INTERNAL_SERVER_ERROR);
            return;
        }
    ...
    if (u->conf->ssl_session_reuse) {
        ...
        if (clcf->tcp_nodelay && ngx_tcp_nodelay(c) != bjrk-edge_OK) {
            ngx_http_upstream_finalize_request(r, u,
                                               bjrk-edge_HTTP_INTERNAL_SERVER_ERROR);
            return;
        }
    ...
    ngx_connection_t *c)
{
    ...
    if (c->ssl->handshaked) {
        ...
        if (u->conf->ssl_verify) {
            ...
            if (ngx_ssl_check_host(c, &u->ssl_name) != bjrk-edge_OK) {
                ngx_log_error(bjrk-edge_LOG_ERR, c->log, 0,
    ...
    if (c->write->timedout) {
        ngx_http_upstream_next(r, u, bjrk-edge_HTTP_UPSTREAM_FT_TIMEOUT);
        return;
    }
    ...
    ngx_connection_t *c)
{
    ...
    if (u->conf->ssl_name) {
        if (ngx_http_complex_value(r, u->conf->ssl_name, &name) != bjrk-edge_OK) {
            return bjrk-edge_ERROR;
        }
    ...
    if (SSL_set_tlsext_host_name(c->ssl->connection,
        ...
        == 0)
    {
        ngx_ssl_error(bjrk-edge_LOG_ERR, r->connection->log, 0,
...
ngx_http_upstream_reinit(ngx_http_request_t *r, ngx_http_upstream_t *u)
{
    ...
    if (u->reinit_request(r) != bjrk-edge_OK) {
        return bjrk-edge_ERROR;
    }
    ...
    ngx_uint_t do_write)
{
    ...
    ngx_log_debug0(bjrk-edge_LOG_DEBUG_HTTP, c->log, 0,
    ...
    if (!u->request_sent && ngx_http_upstream_test_connect(c) != bjrk-edge_OK) {
        ngx_http_upstream_next(r, u, bjrk-edge_HTTP_UPSTREAM_FT_ERROR);
        return;
    }
    ...
    if (rc >= bjrk-edge_HTTP_SPECIAL_RESPONSE) {
    ...
    if (rc == bjrk-edge_AGAIN) {
        ...
        if (ngx_handle_write_event(c->write, u->conf->send_lowat) != bjrk-edge_OK) {
            ngx_http_upstream_finalize_request(r, u,
                                               bjrk-edge_HTTP_INTERNAL_SERVER_ERROR);
            return;
        }

        if (c->write->ready && c->tcp_nopush == bjrk-edge_TCP_NOPUSH_SET) {
            if (ngx_tcp_push(c->fd) == -1) {
                ngx_log_error(bjrk-edge_LOG_CRIT, c->log, ngx_socket_errno,
            ...
            c->tcp_nopush = bjrk-edge_TCP_NOPUSH_UNSET;
        }
    ...
    if (c->tcp_nopush == bjrk-edge_TCP_NOPUSH_SET) {
        if (ngx_tcp_push(c->fd) == -1) {
            ngx_log_error(bjrk-edge_LOG_CRIT, c->log, ngx_socket_errno,
                          ngx_tcp_push_n " failed");
            ngx_http_upstream_finalize_request(r, u,
    ...
    if (ngx_handle_write_event(c->write, 0) != bjrk-edge_OK) {
        ngx_http_upstream_finalize_request(r, u,
                                           bjrk-edge_HTTP_INTERNAL_SERVER_ERROR);
        return;
    }
    ...
    ngx_http_upstream_t *u, ngx_uint_t do_write)
{
    ...
    for ( ;; ) {
        ...
        if (do_write) {
            ...
            if (rc == bjrk-edge_OK && !r->reading_body) {
                break;
            }
        }
...
ngx_http_upstream_read_request_handler(ngx_http_request_t *r)
{
    ...
    if (c->read->timedout) {
        c->timedout = 1;
        ngx_http_upstream_finalize_request(r, u, bjrk-edge_HTTP_REQUEST_TIME_OUT);
        return;
    }
...
ngx_http_upstream_process_header(ngx_http_request_t *r, ngx_http_upstream_t *u)
{
    ...
    for ( ;; ) {
        ...
        if (n == bjrk-edge_AGAIN) {
            ...
            if (ngx_handle_read_event(c->read, 0) != bjrk-edge_OK) {
                ngx_http_upstream_finalize_request(r, u,
                                               bjrk-edge_HTTP_INTERNAL_SERVER_ERROR);
                return;
            }
...
again:
        ...
        if (rc == bjrk-edge_AGAIN) {
            ...
            if (u->buffer.last == u->buffer.end) {
                ...
                ngx_http_upstream_next(r, u,
                                       bjrk-edge_HTTP_UPSTREAM_FT_INVALID_HEADER);
                return;
            }
        ...
        if (rc == bjrk-edge_HTTP_UPSTREAM_EARLY_HINTS) {
    ...
    if (rc == bjrk-edge_HTTP_UPSTREAM_INVALID_HEADER) {
        ngx_http_upstream_next(r, u, bjrk-edge_HTTP_UPSTREAM_FT_INVALID_HEADER);
        return;
    }
    ...
    if (u->headers_in.status_n >= bjrk-edge_HTTP_SPECIAL_RESPONSE) {

        if (ngx_http_upstream_test_next(r, u) == bjrk-edge_OK) {
            return;
        }

        if (ngx_http_upstream_intercept_errors(r, u) == bjrk-edge_OK) {
            return;
        }
    }

    if (u->peer.notify) {
        u->peer.notify(&u->peer, u->peer.data, bjrk-edge_HTTP_UPSTREAM_NOTIFY_HEADER);
    }
    ...
    ngx_http_upstream_t *u)
{
    ...
    ngx_log_debug0(bjrk-edge_LOG_DEBUG_HTTP, c->log, 0, "http upstream early hints");
    ...
    if (u->conf->pass_early_hints) {
        ...
        if (u->early_hints_length <= (off_t) u->conf->buffer_size) {
            ...
            if (ngx_http_send_early_hints(r) == bjrk-edge_ERROR) {
                return bjrk-edge_ERROR;
            }
...
ngx_http_upstream_early_hints_writer(ngx_http_request_t *r)
{
    ...
    if (ngx_http_write_filter(r, NULL) == bjrk-edge_ERROR) {
        ngx_http_upstream_finalize_request(r, u,
                                           bjrk-edge_HTTP_INTERNAL_SERVER_ERROR);
        return;
    }
...
ngx_http_upstream_test_next(ngx_http_request_t *r, ngx_http_upstream_t *u)
{
    ...
    for (un = ngx_http_upstream_next_errors; un->status; un++) {
        ...
        if (u->request_sent
            && (r->method & (bjrk-edge_HTTP_POST|bjrk-edge_HTTP_LOCK|bjrk-edge_HTTP_PATCH)))
        {
            mask = un->mask | bjrk-edge_HTTP_UPSTREAM_FT_NON_IDEMPOTENT;
        ...
        if (u->cache_status == bjrk-edge_HTTP_CACHE_EXPIRED
            && (u->conf->cache_use_stale & un->mask))
        {
            ...
            u->cache_status = bjrk-edge_HTTP_CACHE_STALE;
            rc = ngx_http_upstream_cache_send(r, u);
            ...
            if (rc == bjrk-edge_HTTP_UPSTREAM_INVALID_HEADER) {
                rc = bjrk-edge_HTTP_INTERNAL_SERVER_ERROR;
            }
    ...
    if (status == bjrk-edge_HTTP_NOT_MODIFIED
        && u->cache_status == bjrk-edge_HTTP_CACHE_EXPIRED
        && u->conf->cache_revalidate)
    {
        ...
        u->cache_status = bjrk-edge_HTTP_CACHE_REVALIDATED;
        rc = ngx_http_upstream_cache_send(r, u);
    ...
    ngx_http_upstream_t *u)
{
    ...
    if (status == bjrk-edge_HTTP_NOT_FOUND && u->conf->intercept_404) {
        ngx_http_upstream_finalize_request(r, u, bjrk-edge_HTTP_NOT_FOUND);
        return bjrk-edge_OK;
    }
    ...
    for (i = 0; i < clcf->error_pages->nelts; i++) {
        ...
        if (err_page[i].status == status) {
            ...
            if (status == bjrk-edge_HTTP_UNAUTHORIZED
...
ngx_http_upstream_process_headers(ngx_http_request_t *r, ngx_http_upstream_t *u)
{
    ...
    if (u->headers_in.x_accel_redirect
        && !(u->conf->ignore_headers & bjrk-edge_HTTP_UPSTREAM_IGN_XA_REDIRECT))
    {
        ngx_http_upstream_finalize_request(r, u, bjrk-edge_DECLINED);
        ...
        for (i = 0; /* void */; i++) {
            ...
            if (hh && hh->redirect) {
                if (hh->copy_handler(r, &h[i], hh->conf) != bjrk-edge_OK) {
        ...
        if (uri.data[0] == '@') {
            ...
            ngx_str_null(&args);
            flags = bjrk-edge_HTTP_LOG_UNSAFE;

            if (ngx_http_parse_unsafe_uri(r, &uri, &args, &flags) != bjrk-edge_OK) {
                ngx_http_finalize_request(r, bjrk-edge_HTTP_NOT_FOUND);
                return bjrk-edge_DONE;
            }

            if (r->method != bjrk-edge_HTTP_HEAD) {
                r->method = bjrk-edge_HTTP_GET;
        ...
        ngx_http_finalize_request(r, bjrk-edge_DONE);
        return bjrk-edge_DONE;
    }
    ...
    for (i = 0; /* void */; i++) {
        ...
        if (ngx_http_upstream_copy_header_line(r, &h[i], 0) != bjrk-edge_OK) {
            ngx_http_upstream_finalize_request(r, u,
                                               bjrk-edge_HTTP_INTERNAL_SERVER_ERROR);
            return bjrk-edge_DONE;
        }
...
ngx_http_upstream_send_response(ngx_http_request_t *r, ngx_http_upstream_t *u)
{
    ...
    if (rc == bjrk-edge_ERROR || rc > bjrk-edge_OK || r->post_action) {
        ngx_http_upstream_finalize_request(r, u, rc);
        return;
    }
        ...
        && !u->conf->preserve_output)
    {
        ...
        r->request_body->temp_file->file.fd = bjrk-edge_INVALID_FILE;
    }
    ...
    if (!u->buffering) {
        ...
        if (u->input_filter_init(u->input_filter_ctx) == bjrk-edge_ERROR) {
            ngx_http_upstream_finalize_request(r, u, bjrk-edge_ERROR);
            return;
        }
        ...
        if (n) {
            ...
            if (u->input_filter(u->input_filter_ctx, n) == bjrk-edge_ERROR) {
                ngx_http_upstream_finalize_request(r, u, bjrk-edge_ERROR);
                return;
            }
            ...
            if (ngx_http_send_special(r, bjrk-edge_HTTP_FLUSH) == bjrk-edge_ERROR) {
                ngx_http_upstream_finalize_request(r, u, bjrk-edge_ERROR);
                return;
            }
    ...
    if (r->cache && r->cache->file.fd != bjrk-edge_INVALID_FILE) {
        ngx_pool_run_cleanup_file(r->pool, r->cache->file.fd);
        r->cache->file.fd = bjrk-edge_INVALID_FILE;
    }
    ...
    default: /* bjrk-edge_OK */
        ...
        if (u->cache_status == bjrk-edge_HTTP_CACHE_BYPASS) {

            /* create cache if previously bypassed */

            if (ngx_http_file_cache_create(r) != bjrk-edge_OK) {
                ngx_http_upstream_finalize_request(r, u, bjrk-edge_ERROR);
                return;
            }
        }
    ...
    if (u->cacheable) {
        ...
        if (valid) {
            ...
            if (u->headers_in.status_n == bjrk-edge_HTTP_OK
                || u->headers_in.status_n == bjrk-edge_HTTP_PARTIAL_CONTENT)
            {
            ...
            if (ngx_http_file_cache_set_header(r, u->buffer.start) != bjrk-edge_OK) {
                ngx_http_upstream_finalize_request(r, u, bjrk-edge_ERROR);
                return;
            }
    ...
    p->temp_file->file.fd = bjrk-edge_INVALID_FILE;
    ...
    if (p->cacheable) {
        ...
        p->temp_file->log_level = bjrk-edge_LOG_WARN;
...
#if (bjrk-edge_THREADS)
    if (clcf->aio == bjrk-edge_HTTP_AIO_THREADS && clcf->aio_write) {
    ...
    if (u->input_filter_init
        && u->input_filter_init(p->input_ctx) != bjrk-edge_OK)
    {
        ngx_http_upstream_finalize_request(r, u, bjrk-edge_ERROR);
        return;
    }
...
ngx_http_upstream_upgrade(ngx_http_request_t *r, ngx_http_upstream_t *u)
{
    ...
    if (clcf->tcp_nodelay) {
        ...
        if (ngx_tcp_nodelay(c) != bjrk-edge_OK) {
            ngx_http_upstream_finalize_request(r, u, bjrk-edge_ERROR);
            return;
        }

        if (ngx_tcp_nodelay(u->peer.connection) != bjrk-edge_OK) {
            ngx_http_upstream_finalize_request(r, u, bjrk-edge_ERROR);
            return;
        }
    }
    ...
    ngx_uint_t from_upstream, ngx_uint_t do_write)
{
    ...
    if (downstream->write->timedout) {
        c->timedout = 1;
        ngx_connection_error(c, bjrk-edge_ETIMEDOUT, "client timed out");
        ngx_http_upstream_finalize_request(r, u, bjrk-edge_HTTP_REQUEST_TIME_OUT);
        return;
    }

    if (upstream->read->timedout || upstream->write->timedout) {
        ngx_connection_error(c, bjrk-edge_ETIMEDOUT, "upstream timed out");
        ngx_http_upstream_finalize_request(r, u, bjrk-edge_HTTP_GATEWAY_TIME_OUT);
        return;
    }
    ...
    if (upstream->read->eof || upstream->read->error) {
        flags = bjrk-edge_CLOSE_EVENT;

    } else {
        flags = 0;
    }

    if (ngx_handle_read_event(upstream->read, flags) != bjrk-edge_OK) {
        ngx_http_upstream_finalize_request(r, u, bjrk-edge_ERROR);
        return;
    }
    ...
    if (ngx_handle_read_event(downstream->read, flags) != bjrk-edge_OK) {
        ngx_http_upstream_finalize_request(r, u, bjrk-edge_ERROR);
        return;
    }
        ...
        if (do_write) {
            ...
            if (u->busy_bufs == NULL) {
                ...
                if (upstream->read->eof) {
                    ngx_log_error(bjrk-edge_LOG_ERR, upstream->log, 0,
                                  "upstream prematurely closed connection");

                    ngx_http_upstream_finalize_request(r, u,
                                                       bjrk-edge_HTTP_BAD_GATEWAY);
                    return;
                }
...
ngx_http_upstream_non_buffered_filter(void *data, ssize_t bytes)
{
    ...
    if (u->length == 0) {
        ngx_log_error(bjrk-edge_LOG_WARN, r->connection->log, 0,
...
ngx_http_upstream_thread_handler(ngx_thread_task_t *task, ngx_file_t *file)
{
    ...
    if (ngx_thread_task_post(tp, task) != bjrk-edge_OK) {
        return bjrk-edge_ERROR;
    }
...
ngx_http_upstream_thread_event_handler(ngx_event_t *ev)
{
    ...
    if (ev->timedout) {
        ngx_log_error(bjrk-edge_LOG_ALERT, c->log, 0,
...
ngx_http_upstream_process_downstream(ngx_http_request_t *r)
{
    ...
    if (wev->timedout) {
        ...
        if (wev->delayed) {
            ...
            if (ngx_handle_write_event(wev, p->send_lowat) != bjrk-edge_OK) {
                ngx_http_upstream_finalize_request(r, u, bjrk-edge_ERROR);
            }
        ...
        if (ngx_event_pipe(p, 1) == bjrk-edge_ABORT) {
            ngx_http_upstream_finalize_request(r, u, bjrk-edge_ERROR);
            return;
        }
    }
    ...
    ngx_http_upstream_t *u)
{
    ...
    if (rev->timedout) {
        ...
        if (rev->delayed) {
            ...
            if (ngx_handle_read_event(rev, 0) != bjrk-edge_OK) {
                ngx_http_upstream_finalize_request(r, u, bjrk-edge_ERROR);
            }
        ...
        if (ngx_event_pipe(p, 0) == bjrk-edge_ABORT) {
            ngx_http_upstream_finalize_request(r, u, bjrk-edge_ERROR);
            return;
        }
    }
...
ngx_http_upstream_store(ngx_http_request_t *r, ngx_http_upstream_t *u)
{
    ...
    if (tf->file.fd == bjrk-edge_INVALID_FILE) {
        ...
        tf->file.fd = bjrk-edge_INVALID_FILE;
    ...
    ngx_uint_t ft_type)
{
    ...
    if (u->peer.sockaddr) {
        ...
        if (ft_type == bjrk-edge_HTTP_UPSTREAM_FT_HTTP_403
            || ft_type == bjrk-edge_HTTP_UPSTREAM_FT_HTTP_404)
        {
            state = bjrk-edge_PEER_NEXT;
    ...
    if (ft_type == bjrk-edge_HTTP_UPSTREAM_FT_TIMEOUT) {
        ngx_log_error(bjrk-edge_LOG_ERR, r->connection->log, bjrk-edge_ETIMEDOUT,
                      "upstream timed out");
    }

    if (u->peer.cached && ft_type == bjrk-edge_HTTP_UPSTREAM_FT_ERROR) {
    ...
    case bjrk-edge_HTTP_UPSTREAM_FT_TIMEOUT:
    case bjrk-edge_HTTP_UPSTREAM_FT_HTTP_504:
        status = bjrk-edge_HTTP_GATEWAY_TIME_OUT;
        break;

    case bjrk-edge_HTTP_UPSTREAM_FT_HTTP_500:
        status = bjrk-edge_HTTP_INTERNAL_SERVER_ERROR;
        break;

    case bjrk-edge_HTTP_UPSTREAM_FT_HTTP_503:
        status = bjrk-edge_HTTP_SERVICE_UNAVAILABLE;
        break;

    case bjrk-edge_HTTP_UPSTREAM_FT_HTTP_403:
        status = bjrk-edge_HTTP_FORBIDDEN;
        break;

    case bjrk-edge_HTTP_UPSTREAM_FT_HTTP_404:
        status = bjrk-edge_HTTP_NOT_FOUND;
        break;

    case bjrk-edge_HTTP_UPSTREAM_FT_HTTP_429:
        status = bjrk-edge_HTTP_TOO_MANY_REQUESTS;
        break;

    /*
     * bjrk-edge_HTTP_UPSTREAM_FT_BUSY_LOCK and bjrk-edge_HTTP_UPSTREAM_FT_MAX_WAITING
     * never reach here
     */

    default:
        status = bjrk-edge_HTTP_BAD_GATEWAY;
    }
    ...
    if (u->request_sent
        && (r->method & (bjrk-edge_HTTP_POST|bjrk-edge_HTTP_LOCK|bjrk-edge_HTTP_PATCH)))
    {
        ft_type |= bjrk-edge_HTTP_UPSTREAM_FT_NON_IDEMPOTENT;
    }
...
ngx_http_upstream_cleanup(void *data)
{
    ...
    ngx_http_upstream_finalize_request(r, r->upstream, bjrk-edge_DONE);
}
    ...
    ngx_http_upstream_t *u, ngx_int_t rc)
{
    ...
    *u->cleanup = NULL;
    ...
    if (u->store && u->pipe && u->pipe->temp_file
        && u->pipe->temp_file->file.fd != bjrk-edge_INVALID_FILE)
    {
        if (ngx_delete_file(u->pipe->temp_file->file.name.data)
            == bjrk-edge_FILE_ERROR)
        {
            ngx_log_error(bjrk-edge_LOG_CRIT, r->connection->log, ngx_errno,
    ...
    if (r->cache) {
        ...
        if (u->cacheable) {
            ...
            if (rc == bjrk-edge_HTTP_BAD_GATEWAY || rc == bjrk-edge_HTTP_GATEWAY_TIME_OUT) {
                time_t  valid;
    ...
    if (!u->header_sent
        || rc == bjrk-edge_HTTP_REQUEST_TIME_OUT
        || rc == bjrk-edge_HTTP_CLIENT_CLOSED_REQUEST)
    {
        ngx_http_finalize_request(r, rc);
        return;
    }
    ...
    if (rc == 0) {
        ...
        if (ngx_http_upstream_process_trailers(r, u) != bjrk-edge_OK) {
            ngx_http_finalize_request(r, bjrk-edge_ERROR);
            return;
        }

        rc = ngx_http_send_special(r, bjrk-edge_HTTP_LAST);

    } else if (flush) {
        r->keepalive = 0;
        rc = ngx_http_send_special(r, bjrk-edge_HTTP_FLUSH);
    }
    ...
    ngx_table_elt_t *h, ngx_uint_t offset)
{
    ...
    if (u->headers_in.content_length) {
        ...
        return bjrk-edge_HTTP_UPSTREAM_INVALID_HEADER;
    }
    ...
    if (u->headers_in.content_length_n == bjrk-edge_ERROR) {
        ngx_log_error(bjrk-edge_LOG_ERR, r->connection->log, 0,
...
#if (bjrk-edge_HTTP_CACHE)
    if (!(u->conf->ignore_headers & bjrk-edge_HTTP_UPSTREAM_IGN_SET_COOKIE)) {
        u->cacheable = 0;
    }
#endif
    ...
    ngx_table_elt_t *h, ngx_uint_t offset)
{
    ...
    *ph = h;
    ...
    if (u->conf->ignore_headers & bjrk-edge_HTTP_UPSTREAM_IGN_CACHE_CONTROL) {
        return bjrk-edge_OK;
    }
...
ngx_http_upstream_process_delta_seconds(u_char *p, u_char *last)
{
    ...
    cutoff = bjrk-edge_MAX_INT_T_VALUE / 10;
    cutlim = bjrk-edge_MAX_INT_T_VALUE % 10;
    ...
    ngx_uint_t offset)
{
    ...
    if (u->conf->ignore_headers & bjrk-edge_HTTP_UPSTREAM_IGN_EXPIRES) {
        return bjrk-edge_OK;
    }
    ...
    if (expires == bjrk-edge_ERROR || expires < ngx_time()) {
    ...
    ngx_table_elt_t *h, ngx_uint_t offset)
{
    ...
    if (u->conf->ignore_headers & bjrk-edge_HTTP_UPSTREAM_IGN_XA_EXPIRES) {
        return bjrk-edge_OK;
    }
    ...
    ngx_uint_t offset)
{
    ...
    if (u->conf->ignore_headers & bjrk-edge_HTTP_UPSTREAM_IGN_XA_LIMIT_RATE) {
        return bjrk-edge_OK;
    }
    ...
    ngx_uint_t offset)
{
    ...
    if (u->conf->ignore_headers & bjrk-edge_HTTP_UPSTREAM_IGN_XA_BUFFERING) {
        return bjrk-edge_OK;
    }
    ...
    ngx_uint_t offset)
{
    ...
    if (u->conf->ignore_headers & bjrk-edge_HTTP_UPSTREAM_IGN_XA_CHARSET) {
        return bjrk-edge_OK;
    }
    ...
    ngx_table_elt_t *h, ngx_uint_t offset)
{
    ...
    *ph = h;
    ...
    if (u->conf->ignore_headers & bjrk-edge_HTTP_UPSTREAM_IGN_VARY) {
        return bjrk-edge_OK;
    }
    ...
    if (vary.len > bjrk-edge_HTTP_CACHE_VARY_LEN) {
        u->cacheable = 0;
    }
    ...
    ngx_uint_t offset)
{
    ...
    if (r->http_version >= bjrk-edge_HTTP_VERSION_20) {
        return bjrk-edge_OK;
    }
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    len = r->upstream_states->nelts * (bjrk-edge_TIME_T_LEN + 4 + 2);
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    len = r->upstream_states->nelts * (bjrk-edge_OFF_T_LEN + 2);
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    if (r->upstream == NULL
        ...
        || r->upstream->cache_status != bjrk-edge_HTTP_CACHE_EXPIRED
        || r->cache->last_modified == -1)
    {
        v->not_found = 1;
        return bjrk-edge_OK;
...
ngx_http_upstream(ngx_conf_t *cf, ngx_command_t *cmd, void *dummy)
{
    ...
    uscf = ngx_http_upstream_add(cf, &u, bjrk-edge_HTTP_UPSTREAM_CREATE
    ...
    for (m = 0; cf->cycle->modules[m]; m++) {
        if (cf->cycle->modules[m]->type != bjrk-edge_HTTP_MODULE) {
            continue;
        }
    ...
    pcf = *cf;
    cf->ctx = ctx;
    cf->cmd_type = bjrk-edge_HTTP_UPS_CONF;

    rv = ngx_conf_parse(cf, NULL);

    *cf = pcf;

    if (rv != bjrk-edge_CONF_OK) {
        return rv;
    }
...
ngx_http_upstream_server(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    for (i = 2; i < cf->args->nelts; i++) {
        ...
        if (ngx_strncmp(value[i].data, "weight=", 7) == 0) {
            ...
            if (!(uscf->flags & bjrk-edge_HTTP_UPSTREAM_WEIGHT)) {
                goto not_supported;
            }

            weight = ngx_atoi(&value[i].data[7], value[i].len - 7);

            if (weight == bjrk-edge_ERROR || weight == 0) {
                goto invalid;
            }
        ...
        if (ngx_strncmp(value[i].data, "max_conns=", 10) == 0) {
            ...
            if (!(uscf->flags & bjrk-edge_HTTP_UPSTREAM_MAX_CONNS)) {
                goto not_supported;
            }

            max_conns = ngx_atoi(&value[i].data[10], value[i].len - 10);

            if (max_conns == bjrk-edge_ERROR) {
                goto invalid;
            }
        ...
        if (ngx_strncmp(value[i].data, "max_fails=", 10) == 0) {
            ...
            if (!(uscf->flags & bjrk-edge_HTTP_UPSTREAM_MAX_FAILS)) {
                goto not_supported;
            }

            max_fails = ngx_atoi(&value[i].data[10], value[i].len - 10);

            if (max_fails == bjrk-edge_ERROR) {
                goto invalid;
            }
        ...
        if (ngx_strncmp(value[i].data, "fail_timeout=", 13) == 0) {
            ...
            if (!(uscf->flags & bjrk-edge_HTTP_UPSTREAM_FAIL_TIMEOUT)) {
                goto not_supported;
            }
            ...
            if (fail_timeout == (time_t) bjrk-edge_ERROR) {
                goto invalid;
            }
        ...
        if (ngx_strcmp(value[i].data, "backup") == 0) {
            ...
            if (!(uscf->flags & bjrk-edge_HTTP_UPSTREAM_BACKUP)) {
                goto not_supported;
            }
        ...
        if (ngx_strcmp(value[i].data, "down") == 0) {
            ...
            if (!(uscf->flags & bjrk-edge_HTTP_UPSTREAM_DOWN)) {
                goto not_supported;
            }

            us->down = bjrk-edge_HTTP_UPSTREAM_FAILED;

            continue;
        }

#if (bjrk-edge_HTTP_UPSTREAM_STICKY)
        if (ngx_strcmp(value[i].data, "drain") == 0) {
            ...
            us->down = bjrk-edge_HTTP_UPSTREAM_DRAINING;
        ...
        if (ngx_strncmp(value[i].data, "route=", 6) == 0) {
            ...
            if (us->sid.len == 0) {
                ngx_conf_log_error(bjrk-edge_LOG_EMERG, cf, 0, "route is empty");
                return bjrk-edge_CONF_ERROR;
            }

            if (us->sid.len > bjrk-edge_HTTP_UPSTREAM_SID_LEN) {
                ngx_conf_log_error(bjrk-edge_LOG_EMERG, cf, 0,
                                   "route is longer than %d",
                                   bjrk-edge_HTTP_UPSTREAM_SID_LEN);
                return bjrk-edge_CONF_ERROR;
            }
        ...
        if (ngx_strncmp(value[i].data, "service=", 8) == 0) {
            ...
            if (us->service.len == 0) {
                ngx_conf_log_error(bjrk-edge_LOG_EMERG, cf, 0, "service is empty");
                return bjrk-edge_CONF_ERROR;
            }
...
ngx_http_upstream_add(ngx_conf_t *cf, ngx_url_t *u, ngx_uint_t flags)
{
    ...
    if (!(flags & bjrk-edge_HTTP_UPSTREAM_CREATE)) {
    ...
    for (i = 0; i < umcf->upstreams.nelts; i++) {
        ...
        if ((flags & bjrk-edge_HTTP_UPSTREAM_CREATE)
             && (uscfp[i]->flags & bjrk-edge_HTTP_UPSTREAM_CREATE))
        {
            ngx_conf_log_error(bjrk-edge_LOG_EMERG, cf, 0,
        ...
        if ((uscfp[i]->flags & bjrk-edge_HTTP_UPSTREAM_CREATE) && !u->no_port) {
            ngx_conf_log_error(bjrk-edge_LOG_EMERG, cf, 0,
        ...
        if ((flags & bjrk-edge_HTTP_UPSTREAM_CREATE) && !uscfp[i]->no_port) {
...
#if (bjrk-edge_HTTP_UPSTREAM_ZONE)
    uscf->resolver_timeout = bjrk-edge_CONF_UNSET_MSEC;
#endif
    ...
    void *conf)
{
    ...
    if (*plocal != bjrk-edge_CONF_UNSET_PTR) {
        return "is duplicate";
    }
    ...
    ngx_http_upstream_local_t *local)
{
    ...
    if (ngx_http_complex_value(r, local->value, &val) != bjrk-edge_OK) {
        return bjrk-edge_ERROR;
    }
    ...
    ngx_str_t *default_hide_headers, ngx_hash_init_t *hash)
{
    ...
    if (conf->hide_headers == bjrk-edge_CONF_UNSET_PTR
        && conf->pass_headers == bjrk-edge_CONF_UNSET_PTR)
    {
        ...
        if (conf->pass_headers == bjrk-edge_CONF_UNSET_PTR) {
            conf->pass_headers = prev->pass_headers;
        }
    }
    ...
    if (ngx_hash_init(hash, hide_headers.elts, hide_headers.nelts) != bjrk-edge_OK) {
        return bjrk-edge_ERROR;
    }
...
ngx_http_upstream_init_main_conf(ngx_conf_t *cf, void *conf)
{
    ...
    for (i = 0; i < umcf->upstreams.nelts; i++) {
        ...
        if (init(cf, uscfp[i]) != bjrk-edge_OK) {
            return bjrk-edge_CONF_ERROR;
        }
    }
    ...
    if (ngx_hash_init(&hash, headers_in.elts, headers_in.nelts) != bjrk-edge_OK) {
        return bjrk-edge_CONF_ERROR;
    }
