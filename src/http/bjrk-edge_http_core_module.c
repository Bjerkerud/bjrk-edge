...
#define bjrk-edge_HTTP_REQUEST_BODY_FILE_OFF    0
#define bjrk-edge_HTTP_REQUEST_BODY_FILE_ON     1
#define bjrk-edge_HTTP_REQUEST_BODY_FILE_CLEAN  2
...
static ngx_conf_enum_t  ngx_http_core_request_body_in_file[] = {
    { ngx_string("off"), bjrk-edge_HTTP_REQUEST_BODY_FILE_OFF },
    { ngx_string("on"), bjrk-edge_HTTP_REQUEST_BODY_FILE_ON },
    { ngx_string("clean"), bjrk-edge_HTTP_REQUEST_BODY_FILE_CLEAN },
    { ngx_null_string, 0 }
};


static ngx_conf_enum_t  ngx_http_core_satisfy[] = {
    { ngx_string("all"), bjrk-edge_HTTP_SATISFY_ALL },
    { ngx_string("any"), bjrk-edge_HTTP_SATISFY_ANY },
    { ngx_null_string, 0 }
};


static ngx_conf_enum_t  ngx_http_core_lingering_close[] = {
    { ngx_string("off"), bjrk-edge_HTTP_LINGERING_OFF },
    { ngx_string("on"), bjrk-edge_HTTP_LINGERING_ON },
    { ngx_string("always"), bjrk-edge_HTTP_LINGERING_ALWAYS },
    { ngx_null_string, 0 }
};


static ngx_conf_enum_t  ngx_http_core_server_tokens[] = {
    { ngx_string("off"), bjrk-edge_HTTP_SERVER_TOKENS_OFF },
    { ngx_string("on"), bjrk-edge_HTTP_SERVER_TOKENS_ON },
    { ngx_string("build"), bjrk-edge_HTTP_SERVER_TOKENS_BUILD },
    { ngx_null_string, 0 }
};


static ngx_conf_enum_t  ngx_http_core_if_modified_since[] = {
    { ngx_string("off"), bjrk-edge_HTTP_IMS_OFF },
    { ngx_string("exact"), bjrk-edge_HTTP_IMS_EXACT },
    { ngx_string("before"), bjrk-edge_HTTP_IMS_BEFORE },
    { ngx_null_string, 0 }
};


static ngx_conf_bitmask_t  ngx_http_core_keepalive_disable[] = {
    { ngx_string("none"), bjrk-edge_HTTP_KEEPALIVE_DISABLE_NONE },
    { ngx_string("msie6"), bjrk-edge_HTTP_KEEPALIVE_DISABLE_MSIE6 },
    { ngx_string("safari"), bjrk-edge_HTTP_KEEPALIVE_DISABLE_SAFARI },
    { ngx_null_string, 0 }
};


static ngx_path_init_t  ngx_http_client_temp_path = {
    ngx_string(bjrk-edge_HTTP_CLIENT_TEMP_PATH), { 0, 0, 0 }
};
...
static ngx_conf_enum_t  ngx_http_gzip_http_version[] = {
    { ngx_string("1.0"), bjrk-edge_HTTP_VERSION_10 },
    { ngx_string("1.1"), bjrk-edge_HTTP_VERSION_11 },
    { ngx_null_string, 0 }
};


static ngx_conf_bitmask_t  ngx_http_gzip_proxied_mask[] = {
    { ngx_string("off"), bjrk-edge_HTTP_GZIP_PROXIED_OFF },
    { ngx_string("expired"), bjrk-edge_HTTP_GZIP_PROXIED_EXPIRED },
    { ngx_string("no-cache"), bjrk-edge_HTTP_GZIP_PROXIED_NO_CACHE },
    { ngx_string("no-store"), bjrk-edge_HTTP_GZIP_PROXIED_NO_STORE },
    { ngx_string("private"), bjrk-edge_HTTP_GZIP_PROXIED_PRIVATE },
    { ngx_string("no_last_modified"), bjrk-edge_HTTP_GZIP_PROXIED_NO_LM },
    { ngx_string("no_etag"), bjrk-edge_HTTP_GZIP_PROXIED_NO_ETAG },
    { ngx_string("auth"), bjrk-edge_HTTP_GZIP_PROXIED_AUTH },
    { ngx_string("any"), bjrk-edge_HTTP_GZIP_PROXIED_ANY },
    { ngx_null_string, 0 }
};
...
static ngx_command_t  ngx_http_core_commands[] = {
    ...
    { ngx_string("variables_hash_max_size"),
      bjrk-edge_HTTP_MAIN_CONF|bjrk-edge_CONF_TAKE1,
      ngx_conf_set_num_slot,
      bjrk-edge_HTTP_MAIN_CONF_OFFSET,
    ...
    { ngx_string("server"),
      bjrk-edge_HTTP_MAIN_CONF|bjrk-edge_CONF_BLOCK|bjrk-edge_CONF_NOARGS,
    ...
    { ngx_string("connection_pool_size"),
      bjrk-edge_HTTP_MAIN_CONF|bjrk-edge_HTTP_SRV_CONF|bjrk-edge_CONF_TAKE1,
      ngx_conf_set_size_slot,
      bjrk-edge_HTTP_SRV_CONF_OFFSET,
    ...
    { ngx_string("large_client_header_buffers"),
      bjrk-edge_HTTP_MAIN_CONF|bjrk-edge_HTTP_SRV_CONF|bjrk-edge_CONF_TAKE2,
    ...
    { ngx_string("ignore_invalid_headers"),
      bjrk-edge_HTTP_MAIN_CONF|bjrk-edge_HTTP_SRV_CONF|bjrk-edge_CONF_FLAG,
    ...
    { ngx_string("location"),
      bjrk-edge_HTTP_SRV_CONF|bjrk-edge_HTTP_LOC_CONF|bjrk-edge_CONF_BLOCK|bjrk-edge_CONF_TAKE12,
    ...
    { ngx_string("listen"),
      bjrk-edge_HTTP_SRV_CONF|bjrk-edge_CONF_1MORE,
    ...
    { ngx_string("types"),
      bjrk-edge_HTTP_MAIN_CONF|bjrk-edge_HTTP_SRV_CONF|bjrk-edge_HTTP_LOC_CONF
                                          |bjrk-edge_CONF_BLOCK|bjrk-edge_CONF_NOARGS,
      ngx_http_core_types,
      bjrk-edge_HTTP_LOC_CONF_OFFSET,
      0,
      NULL },
    ...
    { ngx_string("root"),
      bjrk-edge_HTTP_MAIN_CONF|bjrk-edge_HTTP_SRV_CONF|bjrk-edge_HTTP_LOC_CONF|bjrk-edge_HTTP_LIF_CONF
                        |bjrk-edge_CONF_TAKE1,
      ngx_http_core_root,
      bjrk-edge_HTTP_LOC_CONF_OFFSET,
      0,
      NULL },
    ...
    { ngx_string("alias"),
      bjrk-edge_HTTP_LOC_CONF|bjrk-edge_CONF_TAKE1,
      ngx_http_core_root,
      bjrk-edge_HTTP_LOC_CONF_OFFSET,
      0,
      NULL },
    ...
    { ngx_string("limit_except"),
      bjrk-edge_HTTP_LOC_CONF|bjrk-edge_CONF_BLOCK|bjrk-edge_CONF_1MORE,
    ...
    { ngx_string("client_body_temp_path"),
      bjrk-edge_HTTP_MAIN_CONF|bjrk-edge_HTTP_SRV_CONF|bjrk-edge_HTTP_LOC_CONF|bjrk-edge_CONF_TAKE1234,
    ...
    { ngx_string("client_body_in_single_buffer"),
      bjrk-edge_HTTP_MAIN_CONF|bjrk-edge_HTTP_SRV_CONF|bjrk-edge_HTTP_LOC_CONF|bjrk-edge_CONF_FLAG,
      ngx_conf_set_flag_slot,
      bjrk-edge_HTTP_LOC_CONF_OFFSET,
    ...
    { ngx_string("keepalive_timeout"),
      bjrk-edge_HTTP_MAIN_CONF|bjrk-edge_HTTP_SRV_CONF|bjrk-edge_HTTP_LOC_CONF|bjrk-edge_CONF_TAKE12,
    ...
    { ngx_string("internal"),
      bjrk-edge_HTTP_LOC_CONF|bjrk-edge_CONF_NOARGS,
    ...
    { ngx_string("early_hints"),
      bjrk-edge_HTTP_MAIN_CONF|bjrk-edge_HTTP_SRV_CONF|bjrk-edge_HTTP_LOC_CONF|bjrk-edge_CONF_1MORE,
...
ngx_http_handler(ngx_http_request_t *r)
{
    ...
    if (!r->internal) {
        ...
        if (r->method != bjrk-edge_HTTP_CONNECT) {
            switch (r->headers_in.connection_type) {
            case 0:
                r->keepalive = (r->http_version > bjrk-edge_HTTP_VERSION_10);
                break;

            case bjrk-edge_HTTP_CONNECTION_CLOSE:
                r->keepalive = 0;
                break;

            case bjrk-edge_HTTP_CONNECTION_KEEP_ALIVE:
                r->keepalive = 1;
                break;
            }
        }
...
ngx_http_core_generic_phase(ngx_http_request_t *r, ngx_http_phase_handler_t *ph)
{
    ...
    ngx_log_debug1(bjrk-edge_LOG_DEBUG_HTTP, r->connection->log, 0,
    ...
    if (rc == bjrk-edge_AGAIN || rc == bjrk-edge_DONE) {
        return bjrk-edge_OK;
    }

    /* rc == bjrk-edge_ERROR || rc == bjrk-edge_HTTP_...  */
...
ngx_http_core_rewrite_phase(ngx_http_request_t *r, ngx_http_phase_handler_t *ph)
{
    ...
    if (rc == bjrk-edge_DONE) {
        return bjrk-edge_OK;
    }

    /* bjrk-edge_OK, bjrk-edge_AGAIN, bjrk-edge_ERROR, bjrk-edge_HTTP_...  */
    ...
    ngx_http_phase_handler_t *ph)
{
    ...
    if (rc == bjrk-edge_ERROR) {
        ngx_http_finalize_request(r, bjrk-edge_HTTP_INTERNAL_SERVER_ERROR);
        return bjrk-edge_OK;
    }
    ...
    if (!r->internal && clcf->internal) {
        ngx_http_finalize_request(r, bjrk-edge_HTTP_NOT_FOUND);
        return bjrk-edge_OK;
    }

    ngx_log_debug2(bjrk-edge_LOG_DEBUG_HTTP, r->connection->log, 0,
    ...
    {
        ngx_log_error(bjrk-edge_LOG_ERR, r->connection->log, 0,
                      "client intended to send too large body: %O bytes",
                      r->headers_in.content_length_n);

        r->expect_tested = 1;
        (void) ngx_http_discard_request_body(r);
        ngx_http_finalize_request(r, bjrk-edge_HTTP_REQUEST_ENTITY_TOO_LARGE);
        return bjrk-edge_OK;
    }
    ...
    if (rc == bjrk-edge_DONE) {
        ...
        ngx_http_finalize_request(r, bjrk-edge_HTTP_MOVED_PERMANENTLY);
        return bjrk-edge_OK;
    }
...
ngx_http_core_access_phase(ngx_http_request_t *r, ngx_http_phase_handler_t *ph)
{
    ...
    if (clcf->satisfy == bjrk-edge_HTTP_SATISFY_ALL) {
        ...
        if (rc == bjrk-edge_HTTP_FORBIDDEN
            || rc == bjrk-edge_HTTP_UNAUTHORIZED
            || rc == bjrk-edge_HTTP_PROXY_AUTH_REQUIRED)
        {
            if (r->access_code != bjrk-edge_HTTP_UNAUTHORIZED
                && r->access_code != bjrk-edge_HTTP_PROXY_AUTH_REQUIRED)
            {
                r->access_code = rc;
            }
    ...
    if (rc == bjrk-edge_HTTP_UNAUTHORIZED || rc == bjrk-edge_HTTP_PROXY_AUTH_REQUIRED) {
        r->access_code = rc;
    ...
    ngx_http_phase_handler_t *ph)
{
    ...
    if (access_code) {
        if (access_code == bjrk-edge_HTTP_FORBIDDEN) {
            ngx_log_error(bjrk-edge_LOG_ERR, r->connection->log, 0,
                          "access forbidden by rule");
        }

        if (access_code == bjrk-edge_HTTP_UNAUTHORIZED
            || access_code == bjrk-edge_HTTP_PROXY_AUTH_REQUIRED)
        {
            return ngx_http_core_auth_delay(r);
        }
...
ngx_http_core_auth_delay(ngx_http_request_t *r)
{
    ...
    ngx_log_error(bjrk-edge_LOG_INFO, r->connection->log, 0,
    ...
    if (r->connection->read->ready) {
        ...
        if (ngx_handle_read_event(r->connection->read, 0) != bjrk-edge_OK) {
...
ngx_http_core_auth_delay_handler(ngx_http_request_t *r)
{
    ...
    if (wev->delayed) {
        ...
        if (ngx_handle_write_event(wev, 0) != bjrk-edge_OK) {
            ngx_http_finalize_request(r, bjrk-edge_HTTP_INTERNAL_SERVER_ERROR);
        }
    ...
    ngx_http_phase_handler_t *ph)
{
    ...
    if (r->uri.data[r->uri.len - 1] == '/') {
        ...
        ngx_http_finalize_request(r, bjrk-edge_HTTP_FORBIDDEN);
        return bjrk-edge_OK;
    }

    ngx_log_error(bjrk-edge_LOG_ERR, r->connection->log, 0, "no handler found");
...
ngx_http_update_location_config(ngx_http_request_t *r)
{
    ...
    if ((ngx_io.flags & bjrk-edge_IO_SENDFILE) && clcf->sendfile) {
    ...
    if (clcf->client_body_in_file_only) {
        ...
        r->request_body_in_clean_file =
            clcf->client_body_in_file_only == bjrk-edge_HTTP_REQUEST_BODY_FILE_CLEAN;
        r->request_body_file_log_level = bjrk-edge_LOG_NOTICE;

    } else {
        r->request_body_file_log_level = bjrk-edge_LOG_WARN;
    }
    ...
    if (r->keepalive) {
                   ...
                   > clcf->keepalive_time)
        {
            r->keepalive = 0;
                   ...
                   && r->method == bjrk-edge_HTTP_POST
                   && (clcf->keepalive_disable
                       & bjrk-edge_HTTP_KEEPALIVE_DISABLE_MSIE6))
        {
            /*
            ...
            r->keepalive = 0;
                   ...
                   && (clcf->keepalive_disable
                       & bjrk-edge_HTTP_KEEPALIVE_DISABLE_SAFARI))
        {
            /*
    ...
    if (!clcf->tcp_nopush) {
        ...
        r->connection->tcp_nopush = bjrk-edge_TCP_NOPUSH_DISABLED;
    }
...
/*
 * bjrk-edge_OK       - exact or regex match
 * bjrk-edge_DONE     - auto redirect
 * bjrk-edge_AGAIN    - inclusive match
 * bjrk-edge_ERROR    - regex error
 * bjrk-edge_DECLINED - no match
 */
...
ngx_http_core_find_location(ngx_http_request_t *r)
{
    ...
    if (rc == bjrk-edge_OK || rc == bjrk-edge_DONE) {
        return rc;
    }

    /* rc == bjrk-edge_DECLINED or rc == bjrk-edge_AGAIN in nested location */
    ...
    if (noregex == 0 && pclcf->regex_locations) {
        ...
        for (clcfp = pclcf->regex_locations; *clcfp; clcfp++) {
            ...
            if (n == bjrk-edge_OK) {
                ...
                return (rc == bjrk-edge_ERROR) ? rc : bjrk-edge_OK;
            }

            if (n == bjrk-edge_DECLINED) {
                continue;
            }
...
ngx_http_set_etag(ngx_http_request_t *r)
{
    ...
    etag->value.data = ngx_pnalloc(r->pool, bjrk-edge_OFF_T_LEN + bjrk-edge_TIME_T_LEN + 3);
    ...
    ngx_str_t *ct, ngx_http_complex_value_t *cv)
{
    ...
    if (ngx_http_complex_value(r, cv, &val) != bjrk-edge_OK) {
        return bjrk-edge_HTTP_INTERNAL_SERVER_ERROR;
    }

    if (status == bjrk-edge_HTTP_MOVED_PERMANENTLY
        || status == bjrk-edge_HTTP_MOVED_TEMPORARILY
        || status == bjrk-edge_HTTP_SEE_OTHER
        || status == bjrk-edge_HTTP_TEMPORARY_REDIRECT
        || status == bjrk-edge_HTTP_PERMANENT_REDIRECT)
    {
        ngx_http_clear_location(r);
...
ngx_http_send_header(ngx_http_request_t *r)
{
    ...
    if (r->header_sent) {
        ngx_log_error(bjrk-edge_LOG_ALERT, r->connection->log, 0,
                      "header already sent");
        return bjrk-edge_ERROR;
    }
...
ngx_http_output_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    ngx_log_debug2(bjrk-edge_LOG_DEBUG_HTTP, c->log, 0,
                   "http output filter \"%V?%V\"", &r->uri, &r->args);

    rc = ngx_http_top_body_filter(r, in);

    if (rc == bjrk-edge_ERROR) {
        /* bjrk-edge_ERROR may be returned by any filter */
        c->error = 1;
    }
    ...
    size_t *root_length, size_t reserved)
{
    ...
    if (clcf->root_lengths == NULL) {
        ...
        *root_length = clcf->root.len;
        ...
        if (alias == bjrk-edge_MAX_SIZE_T_VALUE) {
...
ngx_http_auth_basic_user(ngx_http_request_t *r)
{
    ...
    if (ngx_decode_base64(&auth, &encoded) != bjrk-edge_OK) {
        r->headers_in.user.data = (u_char *) "";
        return bjrk-edge_DECLINED;
    }
...
ngx_http_gzip_ok(ngx_http_request_t *r)
{
    ...
    if (ngx_memcmp(ae->value.data, "gzip,", 5) != 0
        && ngx_http_gzip_accept_encoding(&ae->value) != bjrk-edge_OK)
    {
        return bjrk-edge_DECLINED;
    }
    ...
    if (p & bjrk-edge_HTTP_GZIP_PROXIED_OFF) {
        return bjrk-edge_DECLINED;
    }

    if (p & bjrk-edge_HTTP_GZIP_PROXIED_ANY) {
        goto ok;
    }

    if (r->headers_in.authorization && (p & bjrk-edge_HTTP_GZIP_PROXIED_AUTH)) {
        goto ok;
    }
    ...
    if (e) {
        ...
        if (!(p & bjrk-edge_HTTP_GZIP_PROXIED_EXPIRED)) {
            return bjrk-edge_DECLINED;
        }

        expires = ngx_parse_http_time(e->value.data, e->value.len);
        if (expires == bjrk-edge_ERROR) {
            return bjrk-edge_DECLINED;
        }
    ...
    if (cc) {
        ...
        if ((p & bjrk-edge_HTTP_GZIP_PROXIED_NO_CACHE)
        ...
        if ((p & bjrk-edge_HTTP_GZIP_PROXIED_NO_STORE)
        ...
        if ((p & bjrk-edge_HTTP_GZIP_PROXIED_PRIVATE)
    ...
    if ((p & bjrk-edge_HTTP_GZIP_PROXIED_NO_LM) && r->headers_out.last_modified) {
        return bjrk-edge_DECLINED;
    }

    if ((p & bjrk-edge_HTTP_GZIP_PROXIED_NO_ETAG) && r->headers_out.etag) {
        return bjrk-edge_DECLINED;
    }
    ...
    ngx_http_post_subrequest_t *ps, ngx_uint_t flags)
{
    ...
    if (r->main->count >= 65535 - 1000) {
        ngx_log_error(bjrk-edge_LOG_CRIT, r->connection->log, 0,
    ...
    sr->signature = bjrk-edge_HTTP_MODULE;
...
#if (bjrk-edge_HTTP_V2)
    sr->stream = r->stream;
#endif

    sr->method = bjrk-edge_HTTP_GET;
    ...
    sr->subrequest_in_memory = (flags & bjrk-edge_HTTP_SUBREQUEST_IN_MEMORY) != 0;
    sr->waited = (flags & bjrk-edge_HTTP_SUBREQUEST_WAITED) != 0;
    sr->background = (flags & bjrk-edge_HTTP_SUBREQUEST_BACKGROUND) != 0;
    ...
    sr->uri_changes = bjrk-edge_HTTP_MAX_URI_CHANGES + 1;
    ...
    *psr = sr;
    ...
    if (flags & bjrk-edge_HTTP_SUBREQUEST_CLONE) {
        sr->method = r->method;
...
ngx_http_named_location(ngx_http_request_t *r, ngx_str_t *name)
{
    ...
    if (cscf->named_locations) {
        ...
        for (clcfp = cscf->named_locations; *clcfp; clcfp++) {
            ...
            ngx_log_debug3(bjrk-edge_LOG_DEBUG_HTTP, r->connection->log, 0,
    ...
    ngx_http_core_loc_conf_t *clcf, ngx_str_t *path, ngx_open_file_info_t *of)
{
    ...
    if (from.len == path->len) {
        of->disable_symlinks = bjrk-edge_DISABLE_SYMLINKS_OFF;
        return bjrk-edge_OK;
    }
    ...
    int recursive)
{
    ...
    for (h = headers; h; h = h->next) {
        ...
        if (rc == bjrk-edge_DECLINED && found) {
            rc = bjrk-edge_DONE;
            break;
        }
    ...
    u_char *xff, size_t xfflen, ngx_array_t *proxies, int recursive)
{
    ...
    do {
        ...
        if (ngx_cidr_match(addr->sockaddr, proxies) != bjrk-edge_OK) {
            return found ? bjrk-edge_DONE : bjrk-edge_DECLINED;
        }
...
ngx_http_core_server(ngx_conf_t *cf, ngx_command_t *cmd, void *dummy)
{
    ...
    for (i = 0; cf->cycle->modules[i]; i++) {
        if (cf->cycle->modules[i]->type != bjrk-edge_HTTP_MODULE) {
            continue;
        }
    ...
    *cscfp = cscf;
    ...
    pcf = *cf;
    cf->ctx = ctx;
    cf->cmd_type = bjrk-edge_HTTP_SRV_CONF;

    rv = ngx_conf_parse(cf, NULL);

    *cf = pcf;

    if (rv == bjrk-edge_CONF_OK && !cscf->listen) {
        ...
        lsopt.backlog = bjrk-edge_LISTEN_BACKLOG;
        ...
        len = bjrk-edge_INET_ADDRSTRLEN + sizeof(":65535") - 1;
        ...
        if (ngx_http_add_listen(cf, cscf, &lsopt) != bjrk-edge_OK) {
            return bjrk-edge_CONF_ERROR;
        }
    }
...
ngx_http_core_location(ngx_conf_t *cf, ngx_command_t *cmd, void *dummy)
{
    ...
    if (cf->args->nelts == 3) {
        ...
        if (len == 1 && mod[0] == '=') {
            ...
            if (ngx_http_core_regex_location(cf, clcf, name, 0) != bjrk-edge_OK) {
                return bjrk-edge_CONF_ERROR;
            }

        } else if (len == 2 && mod[0] == '~' && mod[1] == '*') {

            if (ngx_http_core_regex_location(cf, clcf, name, 1) != bjrk-edge_OK) {
                return bjrk-edge_CONF_ERROR;
            }
    ...
    if (cf->cmd_type == bjrk-edge_HTTP_LOC_CONF) {
    ...
    if (ngx_http_add_location(cf, &pclcf->locations, clcf) != bjrk-edge_OK) {
        return bjrk-edge_CONF_ERROR;
    }

    save = *cf;
    cf->ctx = ctx;
    cf->cmd_type = bjrk-edge_HTTP_LOC_CONF;
    ...
    ngx_str_t *regex, ngx_uint_t caseless)
{
    ...
    u_char               errstr[bjrk-edge_MAX_CONF_ERRSTR];

    ngx_memzero(&rc, sizeof(ngx_regex_compile_t));

    rc.pattern = *regex;
    rc.err.len = bjrk-edge_MAX_CONF_ERRSTR;
    rc.err.data = errstr;

#if (bjrk-edge_HAVE_CASELESS_FILESYSTEM)
    rc.options = bjrk-edge_REGEX_CASELESS;
#else
    rc.options = caseless ? bjrk-edge_REGEX_CASELESS : 0;
#endif
...
ngx_http_core_create_main_conf(ngx_conf_t *cf)
{
    ...
    cmcf->server_names_hash_max_size = bjrk-edge_CONF_UNSET_UINT;
    cmcf->server_names_hash_bucket_size = bjrk-edge_CONF_UNSET_UINT;

    cmcf->variables_hash_max_size = bjrk-edge_CONF_UNSET_UINT;
    cmcf->variables_hash_bucket_size = bjrk-edge_CONF_UNSET_UINT;
...
ngx_http_core_create_srv_conf(ngx_conf_t *cf)
{
    ...
    cscf->connection_pool_size = bjrk-edge_CONF_UNSET_SIZE;
    cscf->request_pool_size = bjrk-edge_CONF_UNSET_SIZE;
    cscf->client_header_timeout = bjrk-edge_CONF_UNSET_MSEC;
    cscf->client_header_buffer_size = bjrk-edge_CONF_UNSET_SIZE;
    cscf->max_headers = bjrk-edge_CONF_UNSET_UINT;
    cscf->ignore_invalid_headers = bjrk-edge_CONF_UNSET;
    cscf->merge_slashes = bjrk-edge_CONF_UNSET;
    cscf->underscores_in_headers = bjrk-edge_CONF_UNSET;
...
ngx_http_core_create_loc_conf(ngx_conf_t *cf)
{
    ...
    clcf->client_max_body_size = bjrk-edge_CONF_UNSET;
    clcf->client_body_buffer_size = bjrk-edge_CONF_UNSET_SIZE;
    clcf->client_body_timeout = bjrk-edge_CONF_UNSET_MSEC;
    clcf->satisfy = bjrk-edge_CONF_UNSET_UINT;
    clcf->auth_delay = bjrk-edge_CONF_UNSET_MSEC;
    clcf->if_modified_since = bjrk-edge_CONF_UNSET_UINT;
    clcf->max_ranges = bjrk-edge_CONF_UNSET_UINT;
    clcf->client_body_in_file_only = bjrk-edge_CONF_UNSET_UINT;
    clcf->client_body_in_single_buffer = bjrk-edge_CONF_UNSET;
    clcf->internal = bjrk-edge_CONF_UNSET;
    clcf->sendfile = bjrk-edge_CONF_UNSET;
    clcf->sendfile_max_chunk = bjrk-edge_CONF_UNSET_SIZE;
    clcf->subrequest_output_buffer_size = bjrk-edge_CONF_UNSET_SIZE;
    clcf->aio = bjrk-edge_CONF_UNSET;
    clcf->aio_write = bjrk-edge_CONF_UNSET;
#if (bjrk-edge_THREADS)
    clcf->thread_pool = bjrk-edge_CONF_UNSET_PTR;
    clcf->thread_pool_value = bjrk-edge_CONF_UNSET_PTR;
#endif
    clcf->read_ahead = bjrk-edge_CONF_UNSET_SIZE;
    clcf->directio = bjrk-edge_CONF_UNSET;
    clcf->directio_alignment = bjrk-edge_CONF_UNSET;
    clcf->tcp_nopush = bjrk-edge_CONF_UNSET;
    clcf->tcp_nodelay = bjrk-edge_CONF_UNSET;
    clcf->send_timeout = bjrk-edge_CONF_UNSET_MSEC;
    clcf->send_lowat = bjrk-edge_CONF_UNSET_SIZE;
    clcf->postpone_output = bjrk-edge_CONF_UNSET_SIZE;
    clcf->limit_rate = bjrk-edge_CONF_UNSET_PTR;
    clcf->limit_rate_after = bjrk-edge_CONF_UNSET_PTR;
    clcf->keepalive_time = bjrk-edge_CONF_UNSET_MSEC;
    clcf->keepalive_timeout = bjrk-edge_CONF_UNSET_MSEC;
    clcf->keepalive_header = bjrk-edge_CONF_UNSET;
    clcf->keepalive_min_timeout = bjrk-edge_CONF_UNSET_MSEC;
    clcf->keepalive_requests = bjrk-edge_CONF_UNSET_UINT;
    clcf->lingering_close = bjrk-edge_CONF_UNSET_UINT;
    clcf->lingering_time = bjrk-edge_CONF_UNSET_MSEC;
    clcf->lingering_timeout = bjrk-edge_CONF_UNSET_MSEC;
    clcf->resolver_timeout = bjrk-edge_CONF_UNSET_MSEC;
    clcf->reset_timedout_connection = bjrk-edge_CONF_UNSET;
    clcf->absolute_redirect = bjrk-edge_CONF_UNSET;
    clcf->server_name_in_redirect = bjrk-edge_CONF_UNSET;
    clcf->port_in_redirect = bjrk-edge_CONF_UNSET;
    clcf->msie_padding = bjrk-edge_CONF_UNSET;
    clcf->msie_refresh = bjrk-edge_CONF_UNSET;
    clcf->log_not_found = bjrk-edge_CONF_UNSET;
    clcf->log_subrequest = bjrk-edge_CONF_UNSET;
    clcf->recursive_error_pages = bjrk-edge_CONF_UNSET;
    clcf->chunked_transfer_encoding = bjrk-edge_CONF_UNSET;
    clcf->etag = bjrk-edge_CONF_UNSET;
    clcf->server_tokens = bjrk-edge_CONF_UNSET_UINT;
    clcf->early_hints = bjrk-edge_CONF_UNSET_PTR;
    clcf->types_hash_max_size = bjrk-edge_CONF_UNSET_UINT;
    clcf->types_hash_bucket_size = bjrk-edge_CONF_UNSET_UINT;

    clcf->open_file_cache = bjrk-edge_CONF_UNSET_PTR;
    clcf->open_file_cache_valid = bjrk-edge_CONF_UNSET;
    clcf->open_file_cache_min_uses = bjrk-edge_CONF_UNSET_UINT;
    clcf->open_file_cache_errors = bjrk-edge_CONF_UNSET;
    clcf->open_file_cache_events = bjrk-edge_CONF_UNSET;

#if (bjrk-edge_HTTP_GZIP)
    clcf->gzip_vary = bjrk-edge_CONF_UNSET;
    clcf->gzip_http_version = bjrk-edge_CONF_UNSET_UINT;
#if (bjrk-edge_PCRE)
    clcf->gzip_disable = bjrk-edge_CONF_UNSET_PTR;
#endif
    clcf->gzip_disable_msie6 = 3;
#if (bjrk-edge_HTTP_DEGRADATION)
    clcf->gzip_disable_degradation = 3;
#endif
#endif

#if (bjrk-edge_HAVE_OPENAT)
    clcf->disable_symlinks = bjrk-edge_CONF_UNSET_UINT;
    clcf->disable_symlinks_from = bjrk-edge_CONF_UNSET_PTR;
#endif
...
ngx_http_core_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (conf->root.data == NULL) {
        ...
        if (prev->root.data == NULL) {
            ...
            if (ngx_conf_full_name(cf->cycle, &conf->root, 0) != bjrk-edge_OK) {
                return bjrk-edge_CONF_ERROR;
            }
        }
    }
    ...
    ngx_conf_merge_bitmask_value(conf->keepalive_disable,
                              ...
                              (bjrk-edge_CONF_BITMASK_SET
                               |bjrk-edge_HTTP_KEEPALIVE_DISABLE_MSIE6));
    ngx_conf_merge_uint_value(conf->satisfy, prev->satisfy,
                              bjrk-edge_HTTP_SATISFY_ALL);
    ngx_conf_merge_msec_value(conf->auth_delay, prev->auth_delay, 0);
    ngx_conf_merge_uint_value(conf->if_modified_since, prev->if_modified_since,
                              bjrk-edge_HTTP_IMS_EXACT);
    ngx_conf_merge_uint_value(conf->max_ranges, prev->max_ranges,
                              bjrk-edge_MAX_INT32_VALUE);
    ngx_conf_merge_uint_value(conf->client_body_in_file_only,
                              prev->client_body_in_file_only,
                              bjrk-edge_HTTP_REQUEST_BODY_FILE_OFF);
    ...
    ngx_conf_merge_size_value(conf->subrequest_output_buffer_size,
                              ...
                              (size_t) ngx_pagesize);
    ngx_conf_merge_value(conf->aio, prev->aio, bjrk-edge_HTTP_AIO_OFF);
    ...
    ngx_conf_merge_off_value(conf->directio, prev->directio,
                              bjrk-edge_OPEN_FILE_DIRECTIO_OFF);
    ...
    ngx_conf_merge_uint_value(conf->lingering_close,
                              prev->lingering_close, bjrk-edge_HTTP_LINGERING_ON);
    ...
    ngx_conf_merge_uint_value(conf->server_tokens, prev->server_tokens,
                              bjrk-edge_HTTP_SERVER_TOKENS_ON);
    ...
    ngx_conf_merge_uint_value(conf->gzip_http_version, prev->gzip_http_version,
                              bjrk-edge_HTTP_VERSION_11);
    ngx_conf_merge_bitmask_value(conf->gzip_proxied, prev->gzip_proxied,
                              (bjrk-edge_CONF_BITMASK_SET|bjrk-edge_HTTP_GZIP_PROXIED_OFF));
    ...
    ngx_conf_merge_uint_value(conf->disable_symlinks, prev->disable_symlinks,
                              bjrk-edge_DISABLE_SYMLINKS_OFF);
...
ngx_http_core_listen(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (ngx_parse_url(cf->pool, &u) != bjrk-edge_OK) {
        if (u.err) {
            ngx_conf_log_error(bjrk-edge_LOG_EMERG, cf, 0,
    ...
    for (n = 2; n < cf->args->nelts; n++) {
        ...
        if (ngx_strncmp(value[n].data, "setfib=", 7) == 0) {
            ...
            if (lsopt.setfib == bjrk-edge_ERROR) {
                ngx_conf_log_error(bjrk-edge_LOG_EMERG, cf, 0,
        ...
        if (ngx_strncmp(value[n].data, "fastopen=", 9) == 0) {
            ...
            if (lsopt.fastopen == bjrk-edge_ERROR) {
                ngx_conf_log_error(bjrk-edge_LOG_EMERG, cf, 0,
        ...
        if (ngx_strncmp(value[n].data, "backlog=", 8) == 0) {
            ...
            if (lsopt.backlog == bjrk-edge_ERROR || lsopt.backlog == 0) {
                ngx_conf_log_error(bjrk-edge_LOG_EMERG, cf, 0,
        ...
        if (ngx_strncmp(value[n].data, "rcvbuf=", 7) == 0) {
            ...
            if (lsopt.rcvbuf == bjrk-edge_ERROR) {
                ngx_conf_log_error(bjrk-edge_LOG_EMERG, cf, 0,
        ...
        if (ngx_strncmp(value[n].data, "sndbuf=", 7) == 0) {
            ...
            if (lsopt.sndbuf == bjrk-edge_ERROR) {
                ngx_conf_log_error(bjrk-edge_LOG_EMERG, cf, 0,
...
#if (bjrk-edge_HAVE_DEFERRED_ACCEPT && defined TCP_DEFER_ACCEPT)
...
#if (bjrk-edge_HAVE_INET6 && defined IPV6_V6ONLY)
        ...
        if (ngx_strncmp(value[n].data, "so_keepalive=", 13) == 0) {
            ...
            if (ngx_strcmp(&value[n].data[13], "on") == 0) {
                ...
                if (p > s.data) {
                    ...
                    if (lsopt.tcp_keepidle == (time_t) bjrk-edge_ERROR) {
                ...
                if (p > s.data) {
                    ...
                    if (lsopt.tcp_keepintvl == (time_t) bjrk-edge_ERROR) {
                        goto invalid_so_keepalive;
                    }
                }
                ...
                if (s.data < end) {
                    ...
                    if (lsopt.tcp_keepcnt == bjrk-edge_ERROR) {
                        goto invalid_so_keepalive;
                    }
                }
...
ngx_http_core_root(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (clcf->root.data[0] != '$') {
        if (ngx_conf_full_name(cf->cycle, &clcf->root, 0) != bjrk-edge_OK) {
            return bjrk-edge_CONF_ERROR;
        }
    }
...
#if (bjrk-edge_PCRE)
    if (alias && clcf->regex) {
        clcf->alias = bjrk-edge_MAX_SIZE_T_VALUE;
        n = 1;
    }
#endif
    ...
    if (n) {
        ...
        if (ngx_http_script_compile(&sc) != bjrk-edge_OK) {
            return bjrk-edge_CONF_ERROR;
        }
    }
...
static ngx_http_method_name_t  ngx_methods_names[] = {
    { (u_char *) "GET",       (uint32_t) ~bjrk-edge_HTTP_GET },
    { (u_char *) "HEAD",      (uint32_t) ~bjrk-edge_HTTP_HEAD },
    { (u_char *) "POST",      (uint32_t) ~bjrk-edge_HTTP_POST },
    { (u_char *) "PUT",       (uint32_t) ~bjrk-edge_HTTP_PUT },
    { (u_char *) "DELETE",    (uint32_t) ~bjrk-edge_HTTP_DELETE },
    { (u_char *) "MKCOL",     (uint32_t) ~bjrk-edge_HTTP_MKCOL },
    { (u_char *) "COPY",      (uint32_t) ~bjrk-edge_HTTP_COPY },
    { (u_char *) "MOVE",      (uint32_t) ~bjrk-edge_HTTP_MOVE },
    { (u_char *) "OPTIONS",   (uint32_t) ~bjrk-edge_HTTP_OPTIONS },
    { (u_char *) "PROPFIND",  (uint32_t) ~bjrk-edge_HTTP_PROPFIND },
    { (u_char *) "PROPPATCH", (uint32_t) ~bjrk-edge_HTTP_PROPPATCH },
    { (u_char *) "LOCK",      (uint32_t) ~bjrk-edge_HTTP_LOCK },
    { (u_char *) "UNLOCK",    (uint32_t) ~bjrk-edge_HTTP_UNLOCK },
    { (u_char *) "PATCH",     (uint32_t) ~bjrk-edge_HTTP_PATCH },
    { NULL, 0 }
};
...
ngx_http_core_limit_except(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (!(pclcf->limit_except & bjrk-edge_HTTP_GET)) {
        pclcf->limit_except &= (uint32_t) ~bjrk-edge_HTTP_HEAD;
    }
    ...
    save = *cf;
    cf->ctx = ctx;
    cf->cmd_type = bjrk-edge_HTTP_LMT_CONF;
...
ngx_http_core_set_aio(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (clcf->aio != bjrk-edge_CONF_UNSET) {
        return "is duplicate";
    }
    ...
    if (ngx_strcmp(value[1].data, "off") == 0) {
        clcf->aio = bjrk-edge_HTTP_AIO_OFF;
        return bjrk-edge_CONF_OK;
    }

    if (ngx_strcmp(value[1].data, "on") == 0) {
#if (bjrk-edge_HAVE_FILE_AIO)
        clcf->aio = bjrk-edge_HTTP_AIO_ON;
        return bjrk-edge_CONF_OK;
#else
        ngx_conf_log_error(bjrk-edge_LOG_EMERG, cf, 0,
                           "\"aio on\" "
        ...
        && (value[1].len == 7 || value[1].data[7] == '='))
    {
        ...
        clcf->aio = bjrk-edge_HTTP_AIO_THREADS;
        ...
        if (value[1].len >= 8) {
            ...
            if (ngx_http_compile_complex_value(&ccv) != bjrk-edge_OK) {
                return bjrk-edge_CONF_ERROR;
            }
...
ngx_http_core_directio(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (clcf->directio != bjrk-edge_CONF_UNSET) {
        return "is duplicate";
    }
    ...
    if (ngx_strcmp(value[1].data, "off") == 0) {
        clcf->directio = bjrk-edge_OPEN_FILE_DIRECTIO_OFF;
        return bjrk-edge_CONF_OK;
    }

    clcf->directio = ngx_parse_offset(&value[1]);
    if (clcf->directio == (off_t) bjrk-edge_ERROR) {
        return "invalid value";
    }
...
ngx_http_core_error_page(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    for (i = 1; i < cf->args->nelts - n; i++) {
        ...
        if (err->status == bjrk-edge_ERROR || err->status == 499) {
            ngx_conf_log_error(bjrk-edge_LOG_EMERG, cf, 0,
                               "invalid value \"%V\"", &value[i]);
            return bjrk-edge_CONF_ERROR;
        }
        ...
        if (overwrite == -1) {
            switch (err->status) {
                case bjrk-edge_HTTP_TO_HTTPS:
                case bjrk-edge_HTTPS_CERT_ERROR:
                case bjrk-edge_HTTPS_NO_CERT:
                case bjrk-edge_HTTP_REQUEST_HEADER_TOO_LARGE:
                    err->overwrite = bjrk-edge_HTTP_BAD_REQUEST;
            }
        }
...
ngx_http_core_open_file_cache(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (clcf->open_file_cache != bjrk-edge_CONF_UNSET_PTR) {
        return "is duplicate";
    }
...
ngx_http_core_keepalive(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (clcf->keepalive_timeout != bjrk-edge_CONF_UNSET_MSEC) {
        return "is duplicate";
    }
    ...
    if (clcf->keepalive_timeout == (ngx_msec_t) bjrk-edge_ERROR) {
        return "invalid value";
    }
    ...
    if (clcf->keepalive_header == (time_t) bjrk-edge_ERROR) {
        return "invalid value";
    }
...
ngx_http_core_internal(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (clcf->internal != bjrk-edge_CONF_UNSET) {
        return "is duplicate";
    }
...
ngx_http_gzip_disable(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (clcf->gzip_disable == bjrk-edge_CONF_UNSET_PTR) {
    ...
    for (i = 1; i < cf->args->nelts; i++) {
        ...
        if (ngx_regex_compile(&rc) != bjrk-edge_OK) {
            ngx_conf_log_error(bjrk-edge_LOG_EMERG, cf, 0, "%V", &rc.err);
            return bjrk-edge_CONF_ERROR;
        }
...
ngx_http_disable_symlinks(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (clcf->disable_symlinks != bjrk-edge_CONF_UNSET_UINT) {
        return "is duplicate";
    }
    ...
    for (i = 1; i < cf->args->nelts; i++) {
        ...
        if (ngx_strcmp(value[i].data, "off") == 0) {
            clcf->disable_symlinks = bjrk-edge_DISABLE_SYMLINKS_OFF;
            continue;
        }

        if (ngx_strcmp(value[i].data, "if_not_owner") == 0) {
            clcf->disable_symlinks = bjrk-edge_DISABLE_SYMLINKS_NOTOWNER;
            continue;
        }

        if (ngx_strcmp(value[i].data, "on") == 0) {
            clcf->disable_symlinks = bjrk-edge_DISABLE_SYMLINKS_ON;
            continue;
        }
    ...
    if (clcf->disable_symlinks_from == bjrk-edge_CONF_UNSET_PTR) {
        ngx_conf_log_error(bjrk-edge_LOG_EMERG, cf, 0,
    ...
    if (clcf->disable_symlinks == bjrk-edge_DISABLE_SYMLINKS_OFF) {
        ngx_conf_log_error(bjrk-edge_LOG_EMERG, cf, 0,
...
#elif !(bjrk-edge_HAVE_SO_SNDLOWAT)
    ssize_t *np = data;
...
ngx_http_core_pool_size(ngx_conf_t *cf, void *post, void *data)
{
    ...
    if (*sp < bjrk-edge_MIN_POOL_SIZE) {
        ngx_conf_log_error(bjrk-edge_LOG_EMERG, cf, 0,
                           "the pool size must be no less than %uz",
                           bjrk-edge_MIN_POOL_SIZE);
        return bjrk-edge_CONF_ERROR;
    }

    if (*sp % bjrk-edge_POOL_ALIGNMENT) {
        ngx_conf_log_error(bjrk-edge_LOG_EMERG, cf, 0,
                           "the pool size must be a multiple of %d",
                           bjrk-edge_POOL_ALIGNMENT);
        return bjrk-edge_CONF_ERROR;
    }
