...
#if (bjrk-edge_QUIC_OPENSSL_COMPAT)
#include <bjrk-edge_event_quic_openssl_compat.h>
#endif
...
#define bjrk-edge_DEFAULT_CIPHERS     "HIGH:!aNULL:!MD5"
#define bjrk-edge_DEFAULT_ECDH_CURVE  "auto"

#define bjrk-edge_HTTP_ALPN_PROTOS    "\x08http/1.1\x08http/1.0\x08http/0.9"
...
static ngx_command_t  ngx_http_ssl_commands[] = {
    ...
    { ngx_string("ssl_certificate_cache"),
      bjrk-edge_HTTP_MAIN_CONF|bjrk-edge_HTTP_SRV_CONF|bjrk-edge_CONF_TAKE123,
    ...
    { ngx_string("ssl_protocols"),
      bjrk-edge_HTTP_MAIN_CONF|bjrk-edge_HTTP_SRV_CONF|bjrk-edge_CONF_1MORE,
    ...
    { ngx_string("ssl_session_cache"),
      bjrk-edge_HTTP_MAIN_CONF|bjrk-edge_HTTP_SRV_CONF|bjrk-edge_CONF_TAKE12,
...
static ngx_http_variable_t  ngx_http_ssl_vars[] = {
    ...
    { ngx_string("ssl_protocol"), NULL, ngx_http_ssl_static_variable,
      (uintptr_t) ngx_ssl_get_protocol, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_cipher"), NULL, ngx_http_ssl_static_variable,
      (uintptr_t) ngx_ssl_get_cipher_name, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_ciphers"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_ciphers, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_curve"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_curve, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_curves"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_curves, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_sigalg"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_sigalg, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_sigalgs"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_sigalgs, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_session_id"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_session_id, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_session_reused"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_session_reused, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_early_data"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_early_data,
      bjrk-edge_HTTP_VAR_CHANGEABLE|bjrk-edge_HTTP_VAR_NOCACHEABLE, 0 },

    { ngx_string("ssl_server_name"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_server_name, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_alpn_protocol"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_alpn_protocol, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_ech_status"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_ech_status, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_ech_outer_server_name"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_ech_outer_server_name,
      bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_client_cert"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_certificate, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },
    ...
    { ngx_string("ssl_client_s_dn"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_subject_dn, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_client_i_dn"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_issuer_dn, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_client_s_dn_legacy"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_subject_dn_legacy, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_client_i_dn_legacy"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_issuer_dn_legacy, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_client_serial"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_serial_number, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_client_fingerprint"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_fingerprint, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_client_verify"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_client_verify, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_client_v_start"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_client_v_start, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_client_v_end"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_client_v_end, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_client_v_remain"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_client_v_remain, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ssl_client_sigalg"), NULL, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_client_sigalg, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },
    ...
    void *arg)
{
    ...
    unsigned int             i;
#endif
#if (bjrk-edge_HTTP_V2 || bjrk-edge_HTTP_V3)
...
#endif
#if (bjrk-edge_HTTP_V2 || bjrk-edge_HTTP_V3 || bjrk-edge_DEBUG)
    ngx_connection_t        *c;
    ...
    if (hc->addr_conf->quic) {
        ...
        if (h3scf->enable && h3scf->enable_hq) {
            srv = (unsigned char *) bjrk-edge_HTTP_V3_ALPN_PROTO
                                    bjrk-edge_HTTP_V3_HQ_ALPN_PROTO;
            srvlen = sizeof(bjrk-edge_HTTP_V3_ALPN_PROTO bjrk-edge_HTTP_V3_HQ_ALPN_PROTO)
                     - 1;

        } else if (h3scf->enable_hq) {
            srv = (unsigned char *) bjrk-edge_HTTP_V3_HQ_ALPN_PROTO;
            srvlen = sizeof(bjrk-edge_HTTP_V3_HQ_ALPN_PROTO) - 1;

        } else if (h3scf->enable) {
            srv = (unsigned char *) bjrk-edge_HTTP_V3_ALPN_PROTO;
            srvlen = sizeof(bjrk-edge_HTTP_V3_ALPN_PROTO) - 1;
...
#endif
    {
        ...
        if (h2scf->enable || hc->addr_conf->http2) {
            srv = (unsigned char *) bjrk-edge_HTTP_V2_ALPN_PROTO bjrk-edge_HTTP_ALPN_PROTOS;
            srvlen = sizeof(bjrk-edge_HTTP_V2_ALPN_PROTO bjrk-edge_HTTP_ALPN_PROTOS) - 1;

        } else
#endif
        {
            srv = (unsigned char *) bjrk-edge_HTTP_ALPN_PROTOS;
            srvlen = sizeof(bjrk-edge_HTTP_ALPN_PROTOS) - 1;
        }
    }
    ...
    uintptr_t data)
{
    ...
    if (r->connection->ssl) {
        ...
        if (handler(r->connection, r->pool, &s) != bjrk-edge_OK) {
...
ngx_http_ssl_create_srv_conf(ngx_conf_t *cf)
{
    ...
    sscf->prefer_server_ciphers = bjrk-edge_CONF_UNSET;
    sscf->certificate_compression = bjrk-edge_CONF_UNSET;
    sscf->early_data = bjrk-edge_CONF_UNSET;
    sscf->reject_handshake = bjrk-edge_CONF_UNSET;
    sscf->buffer_size = bjrk-edge_CONF_UNSET_SIZE;
    sscf->verify = bjrk-edge_CONF_UNSET_UINT;
    sscf->verify_depth = bjrk-edge_CONF_UNSET_UINT;
    sscf->certificates = bjrk-edge_CONF_UNSET_PTR;
    sscf->certificate_keys = bjrk-edge_CONF_UNSET_PTR;
    sscf->certificate_cache = bjrk-edge_CONF_UNSET_PTR;
    sscf->ech_files = bjrk-edge_CONF_UNSET_PTR;
    sscf->passwords = bjrk-edge_CONF_UNSET_PTR;
    sscf->conf_commands = bjrk-edge_CONF_UNSET_PTR;
    sscf->builtin_session_cache = bjrk-edge_CONF_UNSET;
    sscf->session_timeout = bjrk-edge_CONF_UNSET;
    sscf->session_tickets = bjrk-edge_CONF_UNSET;
    sscf->session_ticket_keys = bjrk-edge_CONF_UNSET_PTR;
    sscf->ocsp = bjrk-edge_CONF_UNSET_UINT;
    sscf->ocsp_cache_zone = bjrk-edge_CONF_UNSET_PTR;
    sscf->stapling = bjrk-edge_CONF_UNSET;
    sscf->stapling_verify = bjrk-edge_CONF_UNSET;
...
ngx_http_ssl_merge_srv_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    ngx_conf_merge_str_value(conf->ecdh_curve, prev->ecdh_curve,
                         bjrk-edge_DEFAULT_ECDH_CURVE);

    ngx_conf_merge_str_value(conf->ciphers, prev->ciphers, bjrk-edge_DEFAULT_CIPHERS);
    ...
    if (ngx_ssl_create(&conf->ssl, conf->protocols, conf) != bjrk-edge_OK) {
        return bjrk-edge_CONF_ERROR;
    }
    ...
    if (ngx_ssl_set_client_hello_callback(&conf->ssl, &cb) != bjrk-edge_OK) {
        return bjrk-edge_CONF_ERROR;
    }
    ...
    if (ngx_http_ssl_compile_certificates(cf, conf) != bjrk-edge_OK) {
        return bjrk-edge_CONF_ERROR;
    }
    ...
    if (ngx_ssl_crl(cf, &conf->ssl, &conf->crl) != bjrk-edge_OK) {
        return bjrk-edge_CONF_ERROR;
    }
    ...
    if (ngx_ssl_dhparam(cf, &conf->ssl, &conf->dhparam) != bjrk-edge_OK) {
        return bjrk-edge_CONF_ERROR;
    }

    if (ngx_ssl_ech_files(cf, &conf->ssl, conf->ech_files) != bjrk-edge_OK) {
        return bjrk-edge_CONF_ERROR;
    }

    if (ngx_ssl_ecdh_curve(cf, &conf->ssl, &conf->ecdh_curve) != bjrk-edge_OK) {
        return bjrk-edge_CONF_ERROR;
    }

    ngx_conf_merge_value(conf->builtin_session_cache,
                         prev->builtin_session_cache, bjrk-edge_SSL_NONE_SCACHE);
    ...
    if (ngx_ssl_early_data(cf, &conf->ssl, conf->early_data) != bjrk-edge_OK) {
        return bjrk-edge_CONF_ERROR;
    }

    if (ngx_ssl_conf_commands(cf, &conf->ssl, conf->conf_commands) != bjrk-edge_OK) {
        return bjrk-edge_CONF_ERROR;
    }
...
ngx_http_ssl_certificate_cache(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (sscf->certificate_cache != bjrk-edge_CONF_UNSET_PTR) {
        return "is duplicate";
    }
...
ngx_http_ssl_password_file(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (sscf->passwords != bjrk-edge_CONF_UNSET_PTR) {
        return "is duplicate";
    }
...
ngx_http_ssl_session_cache(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    for (i = 1; i < cf->args->nelts; i++) {
        ...
        if (ngx_strcmp(value[i].data, "off") == 0) {
            sscf->builtin_session_cache = bjrk-edge_SSL_NO_SCACHE;
            continue;
        }

        if (ngx_strcmp(value[i].data, "none") == 0) {
            sscf->builtin_session_cache = bjrk-edge_SSL_NONE_SCACHE;
            continue;
        }

        if (ngx_strcmp(value[i].data, "builtin") == 0) {
            sscf->builtin_session_cache = bjrk-edge_SSL_DFLT_BUILTIN_SCACHE;
            continue;
        }
    ...
    if (sscf->shm_zone && sscf->builtin_session_cache == bjrk-edge_CONF_UNSET) {
        sscf->builtin_session_cache = bjrk-edge_SSL_NO_BUILTIN_SCACHE;
    }
...
ngx_http_ssl_ocsp_cache(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (sscf->ocsp_cache_zone != bjrk-edge_CONF_UNSET_PTR) {
        return "is duplicate";
    }
    ...
    for (p = 0; p < cmcf->ports->nelts; p++) {
        ...
        for (a = 0; a < port[p].addrs.nelts; a++) {
...
#if (bjrk-edge_QUIC_OPENSSL_COMPAT)
                if (ngx_http_ssl_quic_compat_init(cf, &addr[a]) != bjrk-edge_OK) {
                    return bjrk-edge_ERROR;
                }
#endif
            ...
            if (sscf->certificates) {
                ...
                if (addr[a].opt.quic && !(sscf->protocols & bjrk-edge_SSL_TLSv1_3)) {
                    ngx_log_error(bjrk-edge_LOG_EMERG, cf->log, 0,
...
ngx_http_ssl_quic_compat_init(ngx_conf_t *cf, ngx_http_conf_addr_t *addr)
{
    ...
    for (s = 0; s < addr->servers.nelts; s++) {
        ...
        if (sscf->certificates || sscf->reject_handshake) {
            if (ngx_quic_compat_init(cf, sscf->ssl.ctx) != bjrk-edge_OK) {
                return bjrk-edge_ERROR;
            }
        }
    }
