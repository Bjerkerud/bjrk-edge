...
static ngx_command_t  ngx_http_tunnel_commands[] = {
    ...
    { ngx_string("tunnel_pass"),
      bjrk-edge_HTTP_SRV_CONF|bjrk-edge_HTTP_LOC_CONF|bjrk-edge_HTTP_LIF_CONF|bjrk-edge_CONF_NOARGS
...
ngx_http_tunnel_handler(ngx_http_request_t *r)
{
    ...
    if (tlcf->tunnel_lengths) {
        if (ngx_http_tunnel_eval(r, tlcf) != bjrk-edge_OK) {
            return bjrk-edge_HTTP_INTERNAL_SERVER_ERROR;
        }
    }
...
ngx_http_tunnel_process_header(ngx_http_request_t *r)
{
    ...
    u->headers_in.status_n = bjrk-edge_HTTP_OK;
