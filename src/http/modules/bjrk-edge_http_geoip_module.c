...
#define bjrk-edge_GEOIP_COUNTRY_CODE   0
#define bjrk-edge_GEOIP_COUNTRY_CODE3  1
#define bjrk-edge_GEOIP_COUNTRY_NAME   2
...
static ngx_command_t  ngx_http_geoip_commands[] = {
    ...
    { ngx_string("geoip_country"),
      bjrk-edge_HTTP_MAIN_CONF|bjrk-edge_CONF_TAKE12,
    ...
    { ngx_string("geoip_proxy_recursive"),
      bjrk-edge_HTTP_MAIN_CONF|bjrk-edge_CONF_FLAG,
...
static ngx_http_variable_t  ngx_http_geoip_vars[] = {
    ...
    { ngx_string("geoip_country_code"), NULL,
      ...
      bjrk-edge_GEOIP_COUNTRY_CODE, 0, 0 },

    { ngx_string("geoip_country_code3"), NULL,
      ngx_http_geoip_country_variable,
      bjrk-edge_GEOIP_COUNTRY_CODE3, 0, 0 },

    { ngx_string("geoip_country_name"), NULL,
      ngx_http_geoip_country_variable,
      bjrk-edge_GEOIP_COUNTRY_NAME, 0, 0 },
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    v->data = ngx_pnalloc(r->pool, bjrk-edge_INT64_LEN + 5);
    if (v->data == NULL) {
        GeoIPRecord_delete(gr);
        return bjrk-edge_ERROR;
    }
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    v->data = ngx_pnalloc(r->pool, bjrk-edge_INT64_LEN);
    if (v->data == NULL) {
        GeoIPRecord_delete(gr);
        return bjrk-edge_ERROR;
    }
...
ngx_http_geoip_create_conf(ngx_conf_t *cf)
{
    ...
    conf->proxy_recursive = bjrk-edge_CONF_UNSET;
...
ngx_http_geoip_proxy(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (ngx_http_geoip_cidr_value(cf, &value[1], &cidr) != bjrk-edge_OK) {
        return bjrk-edge_CONF_ERROR;
    }
