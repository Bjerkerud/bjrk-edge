...
#include <bjrk-edge_http_proxy_module.h>


#define  bjrk-edge_HTTP_PROXY_COOKIE_SECURE           0x0001
#define  bjrk-edge_HTTP_PROXY_COOKIE_SECURE_ON        0x0002
#define  bjrk-edge_HTTP_PROXY_COOKIE_SECURE_OFF       0x0004
#define  bjrk-edge_HTTP_PROXY_COOKIE_HTTPONLY         0x0008
#define  bjrk-edge_HTTP_PROXY_COOKIE_HTTPONLY_ON      0x0010
#define  bjrk-edge_HTTP_PROXY_COOKIE_HTTPONLY_OFF     0x0020
#define  bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE         0x0040
#define  bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE_STRICT  0x0080
#define  bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE_LAX     0x0100
#define  bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE_NONE    0x0200
#define  bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE_OFF     0x0400
...
static ngx_conf_bitmask_t  ngx_http_proxy_next_upstream_masks[] = {
    { ngx_string("error"), bjrk-edge_HTTP_UPSTREAM_FT_ERROR },
    { ngx_string("timeout"), bjrk-edge_HTTP_UPSTREAM_FT_TIMEOUT },
    { ngx_string("invalid_header"), bjrk-edge_HTTP_UPSTREAM_FT_INVALID_HEADER },
    { ngx_string("non_idempotent"), bjrk-edge_HTTP_UPSTREAM_FT_NON_IDEMPOTENT },
    { ngx_string("http_500"), bjrk-edge_HTTP_UPSTREAM_FT_HTTP_500 },
    { ngx_string("http_502"), bjrk-edge_HTTP_UPSTREAM_FT_HTTP_502 },
    { ngx_string("http_503"), bjrk-edge_HTTP_UPSTREAM_FT_HTTP_503 },
    { ngx_string("http_504"), bjrk-edge_HTTP_UPSTREAM_FT_HTTP_504 },
    { ngx_string("http_403"), bjrk-edge_HTTP_UPSTREAM_FT_HTTP_403 },
    { ngx_string("http_404"), bjrk-edge_HTTP_UPSTREAM_FT_HTTP_404 },
    { ngx_string("http_429"), bjrk-edge_HTTP_UPSTREAM_FT_HTTP_429 },
    { ngx_string("updating"), bjrk-edge_HTTP_UPSTREAM_FT_UPDATING },
    { ngx_string("off"), bjrk-edge_HTTP_UPSTREAM_FT_OFF },
    { ngx_null_string, 0 }
};
...
static ngx_conf_enum_t  ngx_http_proxy_http_version[] = {
    ...
    { ngx_string("2"), bjrk-edge_HTTP_VERSION_20 },
#endif
    { ngx_null_string, 0 }
};
...
static ngx_command_t  ngx_http_proxy_commands[] = {
    ...
    { ngx_string("proxy_pass"),
      bjrk-edge_HTTP_LOC_CONF|bjrk-edge_HTTP_LIF_CONF|bjrk-edge_HTTP_LMT_CONF|bjrk-edge_CONF_TAKE1,
      ngx_http_proxy_pass,
    ...
    { ngx_string("proxy_store_access"),
      bjrk-edge_HTTP_MAIN_CONF|bjrk-edge_HTTP_SRV_CONF|bjrk-edge_HTTP_LOC_CONF|bjrk-edge_CONF_TAKE123,
    ...
    { ngx_string("proxy_set_header"),
      bjrk-edge_HTTP_MAIN_CONF|bjrk-edge_HTTP_SRV_CONF|bjrk-edge_HTTP_LOC_CONF|bjrk-edge_CONF_TAKE2,
    ...
    { ngx_string("proxy_cache_path"),
      bjrk-edge_HTTP_MAIN_CONF|bjrk-edge_CONF_2MORE,
...
static ngx_http_variable_t  ngx_http_proxy_vars[] = {
    ...
    { ngx_string("proxy_host"), NULL, ngx_http_proxy_host_variable, 0,
      bjrk-edge_HTTP_VAR_CHANGEABLE|bjrk-edge_HTTP_VAR_NOCACHEABLE|bjrk-edge_HTTP_VAR_NOHASH, 0 },

    { ngx_string("proxy_port"), NULL, ngx_http_proxy_port_variable, 0,
      bjrk-edge_HTTP_VAR_CHANGEABLE|bjrk-edge_HTTP_VAR_NOCACHEABLE|bjrk-edge_HTTP_VAR_NOHASH, 0 },

    { ngx_string("proxy_add_x_forwarded_for"), NULL,
      ngx_http_proxy_add_x_forwarded_for_variable, 0, bjrk-edge_HTTP_VAR_NOHASH, 0 },

#if 0
    { ngx_string("proxy_add_via"), NULL, NULL, 0, bjrk-edge_HTTP_VAR_NOHASH, 0 },
#endif
...
static ngx_path_init_t  ngx_http_proxy_temp_path = {
    ngx_string(bjrk-edge_HTTP_PROXY_TEMP_PATH), { 1, 2, 0 }
};
...
static ngx_conf_bitmask_t  ngx_http_proxy_cookie_flags_masks[] = {
    ...
    { ngx_string("secure"),
      bjrk-edge_HTTP_PROXY_COOKIE_SECURE|bjrk-edge_HTTP_PROXY_COOKIE_SECURE_ON },

    { ngx_string("nosecure"),
      bjrk-edge_HTTP_PROXY_COOKIE_SECURE|bjrk-edge_HTTP_PROXY_COOKIE_SECURE_OFF },

    { ngx_string("httponly"),
      bjrk-edge_HTTP_PROXY_COOKIE_HTTPONLY|bjrk-edge_HTTP_PROXY_COOKIE_HTTPONLY_ON },

    { ngx_string("nohttponly"),
      bjrk-edge_HTTP_PROXY_COOKIE_HTTPONLY|bjrk-edge_HTTP_PROXY_COOKIE_HTTPONLY_OFF },

    { ngx_string("samesite=strict"),
      bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE|bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE_STRICT },

    { ngx_string("samesite=lax"),
      bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE|bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE_LAX },

    { ngx_string("samesite=none"),
      bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE|bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE_NONE },

    { ngx_string("nosamesite"),
      bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE|bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE_OFF },
...
ngx_http_proxy_handler(ngx_http_request_t *r)
{
...
#if (bjrk-edge_HTTP_V2)
    if (plcf->http_version == bjrk-edge_HTTP_VERSION_20) {
        return ngx_http_proxy_v2_handler(r);
    }
#endif

    if (ngx_http_upstream_create(r) != bjrk-edge_OK) {
    ...
    if (plcf->proxy_lengths == NULL) {
        ...
        if (ngx_http_proxy_eval(r, ctx, plcf) != bjrk-edge_OK) {
            return bjrk-edge_HTTP_INTERNAL_SERVER_ERROR;
        }
    }
    ...
    if (!plcf->upstream.request_buffering
        ...
        && (!r->headers_in.chunked
            || plcf->http_version == bjrk-edge_HTTP_VERSION_11))
    {
    ...
    ngx_http_proxy_loc_conf_t *plcf)
{
    ...
    if (ngx_parse_url(r->pool, &url) != bjrk-edge_OK) {
        if (url.err) {
            ngx_log_error(bjrk-edge_LOG_ERR, r->connection->log, 0,
...
ngx_http_proxy_create_key(ngx_http_request_t *r)
{
    ...
    if (plcf->cache_key.value.data) {
        ...
        if (ngx_http_complex_value(r, &plcf->cache_key, key) != bjrk-edge_OK) {
            return bjrk-edge_ERROR;
        }
    ...
    *key = ctx->vars.key_start;
    ...
    if (r->quoted_uri || r->internal) {
        escape = 2 * ngx_escape_uri(NULL, r->uri.data + loc_len,
                                    r->uri.len - loc_len, bjrk-edge_ESCAPE_URI);
    } else {
        escape = 0;
    }
...
ngx_http_proxy_create_request(ngx_http_request_t *r)
{
    ...
    if (u->method.len) {
        ...
        if (ngx_http_complex_value(r, plcf->method, &method) != bjrk-edge_OK) {
            return bjrk-edge_ERROR;
        }
    ...
    if (plcf->host_value
        && ngx_http_complex_value(r, plcf->host_value, &host) != bjrk-edge_OK)
    {
        return bjrk-edge_ERROR;
    }

    if (plcf->host_value == NULL
        || (host.len == 0 && plcf->http_version == bjrk-edge_HTTP_VERSION_11))
    {
    ...
    *b->last++ = ' ';
    ...
    if (plcf->http_version == bjrk-edge_HTTP_VERSION_11) {
    ...
    while (*(uintptr_t *) le.ip) {
        ...
        if (ngx_http_script_check_length(&e, 2) != bjrk-edge_OK) {
            return bjrk-edge_ERROR;
        }
...
ngx_http_proxy_process_status_line(ngx_http_request_t *r)
{
    ...
    if (rc == bjrk-edge_ERROR) {
        ...
        r->http_version = bjrk-edge_HTTP_VERSION_9;
        u->state->status = bjrk-edge_HTTP_OK;
    ...
    if (ctx->status.http_version < bjrk-edge_HTTP_VERSION_11) {

        if (ctx->status.code == bjrk-edge_HTTP_EARLY_HINTS) {
            ngx_log_error(bjrk-edge_LOG_ERR, r->connection->log, 0,
...
ngx_http_proxy_process_header(ngx_http_request_t *r)
{
    ...
    for ( ;; ) {
        ...
        if (rc == bjrk-edge_OK) {
            ...
            if (r->upstream->headers_in.status_n == bjrk-edge_HTTP_EARLY_HINTS) {
                continue;
            }
        ...
        if (rc == bjrk-edge_HTTP_PARSE_HEADER_DONE) {
            ...
            if (r->upstream->headers_in.status_n == bjrk-edge_HTTP_EARLY_HINTS) {
                ...
                r->state = 0;
                return bjrk-edge_HTTP_UPSTREAM_EARLY_HINTS;
            }
            ...
            if (u->headers_in.status_n == bjrk-edge_HTTP_NO_CONTENT
                || u->headers_in.status_n == bjrk-edge_HTTP_NOT_MODIFIED
                || ctx->head
            ...
            if (u->headers_in.status_n == bjrk-edge_HTTP_SWITCHING_PROTOCOLS) {
                u->keepalive = 0;
        ...
        /* rc == bjrk-edge_HTTP_PARSE_INVALID_HEADER */
...
ngx_http_proxy_input_filter_init(void *data)
{
    ...
    ngx_log_debug4(bjrk-edge_LOG_DEBUG_HTTP, r->connection->log, 0,
...
ngx_http_proxy_copy_filter(ngx_event_pipe_t *p, ngx_buf_t *buf)
{
    ...
    if (p->upstream_done) {
        ngx_log_debug0(bjrk-edge_LOG_DEBUG_HTTP, p->log, 0,
    ...
    if (p->length == 0) {
        ...
        ngx_log_error(bjrk-edge_LOG_WARN, p->log, 0,
    ...
    ngx_log_debug1(bjrk-edge_LOG_DEBUG_EVENT, p->log, 0, "input buf #%d", b->num);
    ...
    for ( ;; ) {
        ...
        if (rc == bjrk-edge_OK) {
            ...
            *prev = b;
            ...
            ngx_log_debug2(bjrk-edge_LOG_DEBUG_EVENT, p->log, 0,
        ...
        ngx_log_error(bjrk-edge_LOG_ERR, p->log, 0,
...
free_buf:
    ...
    ngx_log_debug2(bjrk-edge_LOG_DEBUG_HTTP, p->log, 0,
    ...
    if (ngx_event_pipe_add_free_buf(p, buf) != bjrk-edge_OK) {
        return bjrk-edge_ERROR;
    }
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    v->data = ngx_pnalloc(r->pool, bjrk-edge_OFF_T_LEN);
...
ngx_http_proxy_rewrite_cookie(ngx_http_request_t *r, ngx_table_elt_t *h)
{
    ...
    if (ngx_array_init(&attrs, r->pool, 2, sizeof(ngx_keyval_t)) != bjrk-edge_OK) {
        return bjrk-edge_ERROR;
    }

    if (ngx_http_proxy_parse_cookie(&h->value, &attrs) != bjrk-edge_OK) {
        return bjrk-edge_ERROR;
    }
    ...
    ngx_array_t *flags)
{
    ...
    for (i = 0; i < nelts; i++) {
        ...
        if (ngx_http_complex_value(r, &flags_values[i], &value) != bjrk-edge_OK) {
            return bjrk-edge_ERROR;
        }
    ...
    ngx_uint_t flags)
{
    ...
    for (i = 1; i < attrs->nelts; i++) {
        ...
        {
            if (flags & bjrk-edge_HTTP_PROXY_COOKIE_SECURE_ON) {
                flags &= ~bjrk-edge_HTTP_PROXY_COOKIE_SECURE_ON;

            } else if (flags & bjrk-edge_HTTP_PROXY_COOKIE_SECURE_OFF) {
                key->data = NULL;
            }
        ...
        {
            if (flags & bjrk-edge_HTTP_PROXY_COOKIE_HTTPONLY_ON) {
                flags &= ~bjrk-edge_HTTP_PROXY_COOKIE_HTTPONLY_ON;

            } else if (flags & bjrk-edge_HTTP_PROXY_COOKIE_HTTPONLY_OFF) {
                key->data = NULL;
            }
            ...
            && ngx_strncasecmp(key->data, (u_char *) "samesite", 8) == 0)
        {
            ...
            if (flags & bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE_STRICT) {
                flags &= ~bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE_STRICT;
            ...
            } else if (flags & bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE_LAX) {
                flags &= ~bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE_LAX;
            ...
            } else if (flags & bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE_NONE) {
                flags &= ~bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE_NONE;
            ...
            } else if (flags & bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE_OFF) {
                key->data = NULL;
            }
    ...
    if (flags & (bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE_STRICT
                 |bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE_LAX
                 |bjrk-edge_HTTP_PROXY_COOKIE_SAMESITE_NONE))
    {
        attr = ngx_array_push(attrs);
        if (attr == NULL) {
            return bjrk-edge_ERROR;
    ...
    size_t prefix, size_t len, ngx_http_proxy_rewrite_t *pr)
{
    ...
    if (ngx_http_complex_value(r, &pr->pattern.complex, &pattern) != bjrk-edge_OK) {
        return bjrk-edge_ERROR;
    }
    ...
    if (ngx_http_complex_value(r, &pr->replacement, &replacement) != bjrk-edge_OK) {
        return bjrk-edge_ERROR;
    }
    ...
    size_t prefix, size_t len, ngx_http_proxy_rewrite_t *pr)
{
    ...
    if (ngx_http_regex_exec(r, pr->pattern.regex, &pattern) != bjrk-edge_OK) {
        return bjrk-edge_DECLINED;
    }
...
ngx_http_proxy_create_loc_conf(ngx_conf_t *cf)
{
    ...
    conf->upstream.store = bjrk-edge_CONF_UNSET;
    conf->upstream.store_access = bjrk-edge_CONF_UNSET_UINT;
    conf->upstream.next_upstream_tries = bjrk-edge_CONF_UNSET_UINT;
    conf->upstream.buffering = bjrk-edge_CONF_UNSET;
    conf->upstream.request_buffering = bjrk-edge_CONF_UNSET;
    conf->upstream.ignore_client_abort = bjrk-edge_CONF_UNSET;
    conf->upstream.force_ranges = bjrk-edge_CONF_UNSET;

    conf->upstream.local = bjrk-edge_CONF_UNSET_PTR;
    conf->upstream.socket_keepalive = bjrk-edge_CONF_UNSET;
    conf->upstream.socket_rcvbuf = bjrk-edge_CONF_UNSET_SIZE;
    conf->upstream.socket_sndbuf = bjrk-edge_CONF_UNSET_SIZE;

    conf->upstream.connect_timeout = bjrk-edge_CONF_UNSET_MSEC;
    conf->upstream.send_timeout = bjrk-edge_CONF_UNSET_MSEC;
    conf->upstream.read_timeout = bjrk-edge_CONF_UNSET_MSEC;
    conf->upstream.next_upstream_timeout = bjrk-edge_CONF_UNSET_MSEC;

    conf->upstream.send_lowat = bjrk-edge_CONF_UNSET_SIZE;
    conf->upstream.buffer_size = bjrk-edge_CONF_UNSET_SIZE;
    conf->upstream.limit_rate = bjrk-edge_CONF_UNSET_PTR;

    conf->upstream.busy_buffers_size_conf = bjrk-edge_CONF_UNSET_SIZE;
    conf->upstream.max_temp_file_size_conf = bjrk-edge_CONF_UNSET_SIZE;
    conf->upstream.temp_file_write_size_conf = bjrk-edge_CONF_UNSET_SIZE;

    conf->upstream.pass_request_headers = bjrk-edge_CONF_UNSET;
    conf->upstream.pass_request_body = bjrk-edge_CONF_UNSET;
    conf->upstream.pass_trailers = bjrk-edge_CONF_UNSET;

#if (bjrk-edge_HTTP_CACHE)
    conf->upstream.cache = bjrk-edge_CONF_UNSET;
    conf->upstream.cache_min_uses = bjrk-edge_CONF_UNSET_UINT;
    conf->upstream.cache_max_range_offset = bjrk-edge_CONF_UNSET;
    conf->upstream.cache_bypass = bjrk-edge_CONF_UNSET_PTR;
    conf->upstream.no_cache = bjrk-edge_CONF_UNSET_PTR;
    conf->upstream.cache_valid = bjrk-edge_CONF_UNSET_PTR;
    conf->upstream.cache_lock = bjrk-edge_CONF_UNSET;
    conf->upstream.cache_lock_timeout = bjrk-edge_CONF_UNSET_MSEC;
    conf->upstream.cache_lock_age = bjrk-edge_CONF_UNSET_MSEC;
    conf->upstream.cache_revalidate = bjrk-edge_CONF_UNSET;
    conf->upstream.cache_convert_head = bjrk-edge_CONF_UNSET;
    conf->upstream.cache_background_update = bjrk-edge_CONF_UNSET;
#endif

    conf->upstream.hide_headers = bjrk-edge_CONF_UNSET_PTR;
    conf->upstream.pass_headers = bjrk-edge_CONF_UNSET_PTR;

    conf->upstream.intercept_errors = bjrk-edge_CONF_UNSET;

#if (bjrk-edge_HTTP_SSL)
    conf->upstream.ssl_session_reuse = bjrk-edge_CONF_UNSET;
    conf->upstream.ssl_name = bjrk-edge_CONF_UNSET_PTR;
    conf->upstream.ssl_server_name = bjrk-edge_CONF_UNSET;
    conf->upstream.ssl_verify = bjrk-edge_CONF_UNSET;
    conf->upstream.ssl_certificate = bjrk-edge_CONF_UNSET_PTR;
    conf->upstream.ssl_certificate_key = bjrk-edge_CONF_UNSET_PTR;
    conf->upstream.ssl_certificate_cache = bjrk-edge_CONF_UNSET_PTR;
    conf->upstream.ssl_passwords = bjrk-edge_CONF_UNSET_PTR;
    ...
    conf->headers_source = bjrk-edge_CONF_UNSET_PTR;

    conf->method = bjrk-edge_CONF_UNSET_PTR;

    conf->redirect = bjrk-edge_CONF_UNSET;

    conf->cookie_domains = bjrk-edge_CONF_UNSET_PTR;
    conf->cookie_paths = bjrk-edge_CONF_UNSET_PTR;
    conf->cookie_flags = bjrk-edge_CONF_UNSET_PTR;

    conf->http_version = bjrk-edge_CONF_UNSET_UINT;

    conf->headers_hash_max_size = bjrk-edge_CONF_UNSET_UINT;
    conf->headers_hash_bucket_size = bjrk-edge_CONF_UNSET_UINT;
...
ngx_http_proxy_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (conf->upstream.store == bjrk-edge_CONF_UNSET) {
    ...
    ngx_conf_merge_size_value(conf->upstream.busy_buffers_size_conf,
                              ...
                              bjrk-edge_CONF_UNSET_SIZE);

    if (conf->upstream.busy_buffers_size_conf == bjrk-edge_CONF_UNSET_SIZE) {
    ...
    if (conf->upstream.temp_file_write_size_conf == bjrk-edge_CONF_UNSET_SIZE) {
    ...
    if (conf->upstream.max_temp_file_size_conf == bjrk-edge_CONF_UNSET_SIZE) {
    ...
    ngx_conf_merge_bitmask_value(conf->upstream.next_upstream,
                              ...
                              (bjrk-edge_CONF_BITMASK_SET
                               |bjrk-edge_HTTP_UPSTREAM_FT_ERROR
                               |bjrk-edge_HTTP_UPSTREAM_FT_TIMEOUT));

    if (conf->upstream.next_upstream & bjrk-edge_HTTP_UPSTREAM_FT_OFF) {
        conf->upstream.next_upstream = bjrk-edge_CONF_BITMASK_SET
                                       |bjrk-edge_HTTP_UPSTREAM_FT_OFF;
    }
    ...
    if (conf->upstream.cache == bjrk-edge_CONF_UNSET) {
    ...
    if (conf->upstream.cache_use_stale & bjrk-edge_HTTP_UPSTREAM_FT_OFF) {
        conf->upstream.cache_use_stale = bjrk-edge_CONF_BITMASK_SET
                                         |bjrk-edge_HTTP_UPSTREAM_FT_OFF;
    }

    if (conf->upstream.cache_use_stale & bjrk-edge_HTTP_UPSTREAM_FT_ERROR) {
        conf->upstream.cache_use_stale |= bjrk-edge_HTTP_UPSTREAM_FT_NOLIVE;
    }
    ...
    conf->upstream.cache_methods |= bjrk-edge_HTTP_GET|bjrk-edge_HTTP_HEAD;
    ...
    if (ngx_http_proxy_merge_ssl(cf, conf, prev) != bjrk-edge_OK) {
        return bjrk-edge_CONF_ERROR;
    }
    ...
    if (conf->ssl && ngx_http_proxy_set_ssl(cf, conf) != bjrk-edge_OK) {
        return bjrk-edge_CONF_ERROR;
    }
...
ngx_http_proxy_pass(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (ngx_strncasecmp(url->data, (u_char *) "http://", 7) == 0) {
        ...
        ngx_conf_log_error(bjrk-edge_LOG_EMERG, cf, 0, "invalid URL prefix");
        return bjrk-edge_CONF_ERROR;
    }
...
ngx_http_proxy_redirect(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (value[1].data[0] == '~') {
        ...
        if (value[1].data[0] == '*') {
            ...
            if (ngx_http_proxy_rewrite_regex(cf, pr, &value[1], 1) != bjrk-edge_OK) {
                return bjrk-edge_CONF_ERROR;
            }

        } else {
            if (ngx_http_proxy_rewrite_regex(cf, pr, &value[1], 0) != bjrk-edge_OK) {
                return bjrk-edge_CONF_ERROR;
            }
        }
...
ngx_http_proxy_cookie_domain(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (cf->args->nelts == 2) {
        ...
        if (ngx_strcmp(value[1].data, "off") == 0) {
            ...
            if (plcf->cookie_domains != bjrk-edge_CONF_UNSET_PTR) {
                return "is duplicate";
            }
...
ngx_http_proxy_cookie_path(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (cf->args->nelts == 2) {
        ...
        if (ngx_strcmp(value[1].data, "off") == 0) {
            ...
            if (plcf->cookie_paths != bjrk-edge_CONF_UNSET_PTR) {
                return "is duplicate";
            }
...
ngx_http_proxy_cookie_flags(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (cf->args->nelts == 2) {
        ...
        if (ngx_strcmp(value[1].data, "off") == 0) {
            ...
            if (plcf->cookie_flags != bjrk-edge_CONF_UNSET_PTR) {
                return "is duplicate";
            }
...
ngx_http_proxy_store(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (plcf->upstream.store != bjrk-edge_CONF_UNSET) {
        return "is duplicate";
    }
    ...
    if (value[1].len == 0) {
        ngx_conf_log_error(bjrk-edge_LOG_EMERG, cf, 0, "empty path");
        return bjrk-edge_CONF_ERROR;
    }
...
ngx_http_proxy_cache(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (plcf->upstream.cache != bjrk-edge_CONF_UNSET) {
        return "is duplicate";
    }
    ...
    void *conf)
{
    ...
    if (plcf->upstream.ssl_certificate_cache != bjrk-edge_CONF_UNSET_PTR) {
        return "is duplicate";
    }
...
ngx_http_proxy_ssl_password_file(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (plcf->upstream.ssl_passwords != bjrk-edge_CONF_UNSET_PTR) {
        return "is duplicate";
    }
...
ngx_http_proxy_set_ssl(ngx_conf_t *cf, ngx_http_proxy_loc_conf_t *plcf)
{
    ...
    if (plcf->upstream.ssl_verify) {
        ...
        if (ngx_ssl_crl(cf, plcf->upstream.ssl, &plcf->ssl_crl) != bjrk-edge_OK) {
            return bjrk-edge_ERROR;
        }
    }
