...
static ngx_command_t  ngx_http_upstream_random_commands[] = {
    ...
    { ngx_string("random"),
      bjrk-edge_HTTP_UPS_CONF|bjrk-edge_CONF_NOARGS|bjrk-edge_CONF_TAKE12,
...
{
    ngx_log_debug0(bjrk-edge_LOG_DEBUG_HTTP, cf->log, 0, "init random");
    ...
    ngx_http_upstream_srv_conf_t *us)
{
    ...
    {
        if (ngx_http_upstream_update_random(NULL, us) != bjrk-edge_OK) {
