...
#define  bjrk-edge_HTTP_MODERN_BROWSER   0
#define  bjrk-edge_HTTP_ANCIENT_BROWSER  1
...
static ngx_http_variable_t  ngx_http_browser_vars[] = {
    ...
    { ngx_string("msie"), NULL, ngx_http_msie_variable,
      0, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("modern_browser"), NULL, ngx_http_browser_variable,
      bjrk-edge_HTTP_MODERN_BROWSER, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },

    { ngx_string("ancient_browser"), NULL, ngx_http_browser_variable,
      bjrk-edge_HTTP_ANCIENT_BROWSER, bjrk-edge_HTTP_VAR_CHANGEABLE, 0 },
    ...
    uintptr_t data)
{
    ...
    if (data == bjrk-edge_HTTP_MODERN_BROWSER && rc == bjrk-edge_HTTP_MODERN_BROWSER) {
        *v = *cf->modern_browser_value;
        return bjrk-edge_OK;
    }

    if (data == bjrk-edge_HTTP_ANCIENT_BROWSER && rc == bjrk-edge_HTTP_ANCIENT_BROWSER) {
...
ngx_http_browser(ngx_http_request_t *r, ngx_http_browser_conf_t *cf)
{
    ...
    if (r->headers_in.user_agent == NULL) {
        if (cf->modern_unlisted_browsers) {
            return bjrk-edge_HTTP_MODERN_BROWSER;
        }

        return bjrk-edge_HTTP_ANCIENT_BROWSER;
    }
