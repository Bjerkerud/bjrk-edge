...
#ifndef _bjrk-edge_HTTP_V3_PARSE_H_INCLUDED_
#define _bjrk-edge_HTTP_V3_PARSE_H_INCLUDED_
 ...
 *   bjrk-edge_DONE - parsing done
 *   bjrk-edge_OK - sub-element done
 *   bjrk-edge_AGAIN - more data expected
 *   bjrk-edge_BUSY - waiting for external event
 *   bjrk-edge_ERROR - internal error
 *   bjrk-edge_HTTP_V3_ERROR_XXX - HTTP/3 or QPACK error
 */
...
#endif /* _bjrk-edge_HTTP_V3_PARSE_H_INCLUDED_ */
