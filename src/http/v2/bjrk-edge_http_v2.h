...
#ifndef _bjrk-edge_HTTP_V2_H_INCLUDED_
#define _bjrk-edge_HTTP_V2_H_INCLUDED_
...
#define bjrk-edge_HTTP_V2_ALPN_PROTO           "\x02h2"

#define bjrk-edge_HTTP_V2_STATE_BUFFER_SIZE    16

#define bjrk-edge_HTTP_V2_DEFAULT_FRAME_SIZE   (1 << 14)
#define bjrk-edge_HTTP_V2_MAX_FRAME_SIZE       ((1 << 24) - 1)

#define bjrk-edge_HTTP_V2_INT_OCTETS           4
#define bjrk-edge_HTTP_V2_MAX_FIELD                                                 \
    (127 + (1 << (bjrk-edge_HTTP_V2_INT_OCTETS - 1) * 7) - 1)

#define bjrk-edge_HTTP_V2_FRAME_HEADER_SIZE    9

/* frame types */
#define bjrk-edge_HTTP_V2_DATA_FRAME           0x0
#define bjrk-edge_HTTP_V2_HEADERS_FRAME        0x1
#define bjrk-edge_HTTP_V2_PRIORITY_FRAME       0x2
#define bjrk-edge_HTTP_V2_RST_STREAM_FRAME     0x3
#define bjrk-edge_HTTP_V2_SETTINGS_FRAME       0x4
#define bjrk-edge_HTTP_V2_PUSH_PROMISE_FRAME   0x5
#define bjrk-edge_HTTP_V2_PING_FRAME           0x6
#define bjrk-edge_HTTP_V2_GOAWAY_FRAME         0x7
#define bjrk-edge_HTTP_V2_WINDOW_UPDATE_FRAME  0x8
#define bjrk-edge_HTTP_V2_CONTINUATION_FRAME   0x9

/* frame flags */
#define bjrk-edge_HTTP_V2_NO_FLAG              0x00
#define bjrk-edge_HTTP_V2_ACK_FLAG             0x01
#define bjrk-edge_HTTP_V2_END_STREAM_FLAG      0x01
#define bjrk-edge_HTTP_V2_END_HEADERS_FLAG     0x04
#define bjrk-edge_HTTP_V2_PADDED_FLAG          0x08
#define bjrk-edge_HTTP_V2_PRIORITY_FLAG        0x20

#define bjrk-edge_HTTP_V2_MAX_WINDOW           ((1U << 31) - 1)
#define bjrk-edge_HTTP_V2_DEFAULT_WINDOW       65535

#define bjrk-edge_HTTP_V2_DEFAULT_WEIGHT       16
...
typedef struct {
    ...
    u_char                           buffer[bjrk-edge_HTTP_V2_STATE_BUFFER_SIZE];
    size_t                           buffer_used;
...
#define bjrk-edge_HTTP_V2_ENCODE_RAW            0
#define bjrk-edge_HTTP_V2_ENCODE_HUFF           0x80

#define bjrk-edge_HTTP_V2_AUTHORITY_INDEX       1

#define bjrk-edge_HTTP_V2_METHOD_INDEX          2
#define bjrk-edge_HTTP_V2_METHOD_GET_INDEX      2
#define bjrk-edge_HTTP_V2_METHOD_POST_INDEX     3

#define bjrk-edge_HTTP_V2_PATH_INDEX            4
#define bjrk-edge_HTTP_V2_PATH_ROOT_INDEX       4

#define bjrk-edge_HTTP_V2_SCHEME_HTTP_INDEX     6
#define bjrk-edge_HTTP_V2_SCHEME_HTTPS_INDEX    7

#define bjrk-edge_HTTP_V2_STATUS_INDEX          8
#define bjrk-edge_HTTP_V2_STATUS_200_INDEX      8
#define bjrk-edge_HTTP_V2_STATUS_204_INDEX      9
#define bjrk-edge_HTTP_V2_STATUS_206_INDEX      10
#define bjrk-edge_HTTP_V2_STATUS_304_INDEX      11
#define bjrk-edge_HTTP_V2_STATUS_400_INDEX      12
#define bjrk-edge_HTTP_V2_STATUS_404_INDEX      13
#define bjrk-edge_HTTP_V2_STATUS_500_INDEX      14

#define bjrk-edge_HTTP_V2_CONTENT_LENGTH_INDEX  28
#define bjrk-edge_HTTP_V2_CONTENT_TYPE_INDEX    31
#define bjrk-edge_HTTP_V2_DATE_INDEX            33
#define bjrk-edge_HTTP_V2_LAST_MODIFIED_INDEX   44
#define bjrk-edge_HTTP_V2_LOCATION_INDEX        46
#define bjrk-edge_HTTP_V2_SERVER_INDEX          54
#define bjrk-edge_HTTP_V2_VARY_INDEX            59

#define bjrk-edge_HTTP_V2_PREFACE_START         "PRI * HTTP/2.0\r\n"
#define bjrk-edge_HTTP_V2_PREFACE_END           "\r\nSM\r\n\r\n"
#define bjrk-edge_HTTP_V2_PREFACE               bjrk-edge_HTTP_V2_PREFACE_START           \
                                          bjrk-edge_HTTP_V2_PREFACE_END
...
#endif /* _bjrk-edge_HTTP_V2_H_INCLUDED_ */
